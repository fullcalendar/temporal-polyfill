...
describe.skip('Instant', () => {
  ...
  describe('Construction', () => {
    it('can construct', () => {
      ...
      equal(
        ...
        Math.floor(Date.UTC(1976, 10, 18, 14, 23, 30, 123) / 1e3),
        'epochSeconds'
      )
      equal(
    ...
    it('constructs from string', () => {
      return equal(`${new Instant('0')}`, '1970-01-01T00:00:00Z')
    })
    it('throws on number', () => {
      return throws(() => {
        return new Instant(1234)
      }, TypeError)
    })
    it('throws on string that does not convert to BigInt', () => {
      return throws(() => {
        return new Instant('abc123')
      }, SyntaxError)
    })
  })
  describe('instant.toString() works', () => {
    ...
    it('truncates to minute', () => {
      ;[i1, i2, i3].forEach((i) => {
        return equal(
          i.toString({ smallestUnit: 'minute' }),
          '1976-11-18T15:23Z'
        )
      })
    })
    it('other smallestUnits are aliases for fractional digits', () => {
      equal(
        i3.toString({ smallestUnit: 'second' }),
        i3.toString({ fractionalSecondDigits: 0 })
      )
      equal(
        i3.toString({ smallestUnit: 'millisecond' }),
        i3.toString({ fractionalSecondDigits: 3 })
      )
      equal(
        i3.toString({ smallestUnit: 'microsecond' }),
        i3.toString({ fractionalSecondDigits: 6 })
      )
      equal(
        i3.toString({ smallestUnit: 'nanosecond' }),
        i3.toString({ fractionalSecondDigits: 9 })
      )
    })
    it('throws on invalid or disallowed smallestUnit', () => {
      ;['era', 'year', 'month', 'day', 'hour', 'nonsense'].forEach(
        (smallestUnit) => {
          return throws(() => {
            return i1.toString({ smallestUnit })
          }, RangeError)
        }
      )
    })
    it('accepts plural units', () => {
      equal(
        i3.toString({ smallestUnit: 'minutes' }),
        i3.toString({ smallestUnit: 'minute' })
      )
      equal(
        i3.toString({ smallestUnit: 'seconds' }),
        i3.toString({ smallestUnit: 'second' })
      )
      equal(
        i3.toString({ smallestUnit: 'milliseconds' }),
        i3.toString({ smallestUnit: 'millisecond' })
      )
      equal(
        i3.toString({ smallestUnit: 'microseconds' }),
        i3.toString({ smallestUnit: 'microsecond' })
      )
      equal(
        i3.toString({ smallestUnit: 'nanoseconds' }),
        i3.toString({ smallestUnit: 'nanosecond' })
      )
    })
    ...
    it('auto is the default', () => {
      ;[i1, i2, i3].forEach((i) => {
        return equal(
          i.toString({ fractionalSecondDigits: 'auto' }),
          i.toString()
        )
      })
    })
    it('throws on out of range or invalid fractionalSecondDigits', () => {
      ;[-1, 10, Infinity, NaN, 'not-auto'].forEach((fractionalSecondDigits) => {
        return throws(() => {
          return i1.toString({ fractionalSecondDigits })
        }, RangeError)
      })
    })
    it('accepts and truncates fractional fractionalSecondDigits', () => {
      equal(
        i3.toString({ fractionalSecondDigits: 5.5 }),
        '1976-11-18T15:23:30.12340Z'
      )
    })
    it('smallestUnit overrides fractionalSecondDigits', () => {
      equal(
        i3.toString({ smallestUnit: 'minute', fractionalSecondDigits: 9 }),
        '1976-11-18T15:23Z'
      )
    })
    it('throws on invalid roundingMode', () => {
      throws(() => {
        return i1.toString({ roundingMode: 'cile' })
      }, RangeError)
    })
    it('rounds to nearest', () => {
      equal(
        i2.toString({ smallestUnit: 'minute', roundingMode: 'halfExpand' }),
        '1976-11-18T15:24Z'
      )
      equal(
        i3.toString({ fractionalSecondDigits: 3, roundingMode: 'halfExpand' }),
        '1976-11-18T15:23:30.123Z'
      )
    })
    it('rounds up', () => {
      equal(
        i2.toString({ smallestUnit: 'minute', roundingMode: 'ceil' }),
        '1976-11-18T15:24Z'
      )
      equal(
        i3.toString({ fractionalSecondDigits: 3, roundingMode: 'ceil' }),
        '1976-11-18T15:23:30.124Z'
      )
    })
    it('rounds down', () => {
      ;['floor', 'trunc'].forEach((roundingMode) => {
        equal(
          i2.toString({ smallestUnit: 'minute', roundingMode }),
          '1976-11-18T15:23Z'
        )
        equal(
          i3.toString({ fractionalSecondDigits: 3, roundingMode }),
          '1976-11-18T15:23:30.123Z'
        )
      })
    })
    it('rounding down is towards the Big Bang, not towards 1 BCE', () => {
      ...
      equal(
        i4.toString({ smallestUnit: 'second', roundingMode: 'floor' }),
    ...
    it('rounding can affect all units', () => {
      ...
      equal(
        i5.toString({ fractionalSecondDigits: 8, roundingMode: 'halfExpand' }),
    ...
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return i1.toString(badOptions)
        }, TypeError)
      })
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(i1.toString(options), '1976-11-18T15:23:00Z')
      })
    })
  })
  ...
  describe('Instant.fromEpochSeconds() works', () => {
    ...
    it('1963-02-13T09:36:29', () => {
      const epochSeconds = Math.floor(
        Date.UTC(1963, 1, 13, 9, 36, 29, 123) / 1e3
      )
      const instant = Instant.fromEpochSeconds(epochSeconds)
      equal(instant.epochSeconds, epochSeconds)
    })
  ...
  describe('Instant.fromEpochMicroseconds() works', () => {
    it('1976-11-18T15:23:30.123456', () => {
      const epochMicroseconds =
        BigInt(Date.UTC(1976, 10, 18, 15, 23, 30, 123)) * BigInt(1e3) +
        BigInt(456)
    ...
    it('1963-02-13T09:36:29.123456', () => {
      const epochMicroseconds =
        BigInt(Date.UTC(1963, 1, 13, 9, 36, 29, 123)) * BigInt(1e3) +
        BigInt(456)
      const instant = Instant.fromEpochMicroseconds(epochMicroseconds)
      equal(instant.epochMicroseconds, epochMicroseconds)
    })
  ...
  describe('Instant.fromEpochNanoseconds() works', () => {
    it('1976-11-18T15:23:30.123456789', () => {
      const epochNanoseconds =
        BigInt(Date.UTC(1976, 10, 18, 15, 23, 30, 123)) * BigInt(1e6) +
        BigInt(456789)
    ...
    it('1963-02-13T09:36:29.123456789', () => {
      const epochNanoseconds =
        BigInt(Date.UTC(1963, 1, 13, 9, 36, 29, 123)) * BigInt(1e6) +
        BigInt(456789)
      const instant = Instant.fromEpochNanoseconds(epochNanoseconds)
      equal(instant.epochNanoseconds, epochNanoseconds)
    })
  ...
  describe('Instant.from() works', () => {
    it('1976-11-18T15:23Z', () => {
      equal(
        Instant.from('1976-11-18T15:23Z').epochMilliseconds,
        Date.UTC(1976, 10, 18, 15, 23)
      )
    })
    it('1976-11-18T15:23:30Z', () => {
      equal(
        Instant.from('1976-11-18T15:23:30Z').epochMilliseconds,
        Date.UTC(1976, 10, 18, 15, 23, 30)
      )
    })
    it('1976-11-18T15:23:30.123Z', () => {
      equal(
        Instant.from('1976-11-18T15:23:30.123Z').epochMilliseconds,
    ...
    it('2020-02-12T11:42-08:00[America/Vancouver]', () => {
      equal(
        Instant.from('2020-02-12T11:42-08:00[America/Vancouver]')
          .epochNanoseconds,
        BigInt(Date.UTC(2020, 1, 12, 19, 42)) * BigInt(1e6)
      )
    })
    ...
    it('2020-02-12T11:42+01:00[Europe/Amsterdam]', () => {
      equal(
        Instant.from('2020-02-12T11:42+01:00[Europe/Amsterdam]')
          .epochNanoseconds,
        BigInt(Date.UTC(2020, 1, 12, 10, 42)) * BigInt(1e6)
      )
    })
    it('2019-02-16T23:45-02:00[America/Sao_Paulo]', () => {
      equal(
        Instant.from('2019-02-16T23:45-02:00[America/Sao_Paulo]')
          .epochNanoseconds,
    ...
    it('2019-02-16T23:45-03:00[America/Sao_Paulo]', () => {
      equal(
        Instant.from('2019-02-16T23:45-03:00[America/Sao_Paulo]')
          .epochNanoseconds,
    ...
    it('sub-minute offset', () => {
      equal(
        Instant.from('1900-01-01T12:19:32+00:19:32[Europe/Amsterdam]')
          .epochNanoseconds,
    ...
    it('throws when offset not provided', () => {
      throws(() => {
        return Instant.from('2019-02-16T23:45[America/Sao_Paulo]')
      }, RangeError)
    })
    it('ignores the bracketed IANA time zone when the offset is incorrect', () => {
      equal(
        Instant.from('2019-02-16T23:45-04:00[America/Sao_Paulo]')
          .epochNanoseconds,
    ...
    it('any number of decimal places', () => {
      equal(
        `${Instant.from('1976-11-18T15:23:30.1Z')}`,
        '1976-11-18T15:23:30.1Z'
      )
      equal(
        `${Instant.from('1976-11-18T15:23:30.12Z')}`,
        '1976-11-18T15:23:30.12Z'
      )
      equal(
        `${Instant.from('1976-11-18T15:23:30.123Z')}`,
        '1976-11-18T15:23:30.123Z'
      )
      equal(
        `${Instant.from('1976-11-18T15:23:30.1234Z')}`,
        '1976-11-18T15:23:30.1234Z'
      )
      equal(
        `${Instant.from('1976-11-18T15:23:30.12345Z')}`,
        '1976-11-18T15:23:30.12345Z'
      )
      equal(
        `${Instant.from('1976-11-18T15:23:30.123456Z')}`,
        '1976-11-18T15:23:30.123456Z'
      )
      equal(
        `${Instant.from('1976-11-18T15:23:30.1234567Z')}`,
        '1976-11-18T15:23:30.1234567Z'
      )
      equal(
        `${Instant.from('1976-11-18T15:23:30.12345678Z')}`,
        '1976-11-18T15:23:30.12345678Z'
      )
      equal(
        `${Instant.from('1976-11-18T15:23:30.123456789Z')}`,
    ...
    it('variant minus sign', () => {
      equal(
        `${Instant.from('1976-11-18T15:23:30.12\u221202:00')}`,
        '1976-11-18T17:23:30.12Z'
      )
      equal(
        `${Instant.from('\u2212009999-11-18T15:23:30.12Z')}`,
        '-009999-11-18T15:23:30.12Z'
      )
    })
    it('mixture of basic and extended format', () => {
      equal(
        `${Instant.from('19761118T15:23:30.1+00:00')}`,
        '1976-11-18T15:23:30.1Z'
      )
      equal(
        `${Instant.from('1976-11-18T152330.1+00:00')}`,
        '1976-11-18T15:23:30.1Z'
      )
      equal(
        `${Instant.from('1976-11-18T15:23:30.1+0000')}`,
        '1976-11-18T15:23:30.1Z'
      )
      equal(
        `${Instant.from('1976-11-18T152330.1+0000')}`,
        '1976-11-18T15:23:30.1Z'
      )
      equal(
        `${Instant.from('19761118T15:23:30.1+0000')}`,
        '1976-11-18T15:23:30.1Z'
      )
      equal(
        `${Instant.from('19761118T152330.1+00:00')}`,
        '1976-11-18T15:23:30.1Z'
      )
      equal(
        `${Instant.from('+0019761118T15:23:30.1+00:00')}`,
        '1976-11-18T15:23:30.1Z'
      )
      equal(
        `${Instant.from('+001976-11-18T152330.1+00:00')}`,
        '1976-11-18T15:23:30.1Z'
      )
      equal(
        `${Instant.from('+001976-11-18T15:23:30.1+0000')}`,
        '1976-11-18T15:23:30.1Z'
      )
      equal(
        `${Instant.from('+001976-11-18T152330.1+0000')}`,
        '1976-11-18T15:23:30.1Z'
      )
      equal(
        `${Instant.from('+0019761118T15:23:30.1+0000')}`,
        '1976-11-18T15:23:30.1Z'
      )
      equal(
        `${Instant.from('+0019761118T152330.1+00:00')}`,
        '1976-11-18T15:23:30.1Z'
      )
      equal(
        `${Instant.from('+0019761118T152330.1+0000')}`,
        '1976-11-18T15:23:30.1Z'
      )
    })
    it('optional parts', () => {
    ...
    it('ignores any specified calendar', () => {
      return equal(
        `${Instant.from('1976-11-18T15:23:30.123456789Z[u-ca=discord]')}`,
        '1976-11-18T15:23:30.123456789Z'
      )
    })
    it('no junk at end of string', () => {
      return throws(() => {
        return Instant.from('1976-11-18T15:23:30.123456789Zjunk')
      }, RangeError)
    })
  })
  describe('Instant.add works', () => {
    ...
    describe('cross epoch in ms', () => {
      ...
      it(`(${inst}).subtract({ hours: 240, nanoseconds: 800 }) = ${one}`, () => {
        return equal(`${one}`, '1969-12-15T12:23:45.678900434Z')
      })
      it(`(${inst}).add({ hours: 240, nanoseconds: 800 }) = ${two}`, () => {
        return equal(`${two}`, '1970-01-04T12:23:45.678902034Z')
      })
    ...
    it('casts argument', () => {
      equal(
        `${inst.add('PT240H0.000000800S')}`,
        '1970-01-04T12:23:45.678902034Z'
      )
    })
    it('invalid to add years, months, weeks, or days', () => {
      throws(() => {
        return inst.add({ years: 1 })
      }, RangeError)
      throws(() => {
        return inst.add({ months: 1 })
      }, RangeError)
      throws(() => {
        return inst.add({ weeks: 1 })
      }, RangeError)
      throws(() => {
        return inst.add({ days: 1 })
      }, RangeError)
    })
    it('mixed positive and negative values always throw', () => {
      throws(() => {
        return inst.add({ hours: 1, minutes: -30 })
      }, RangeError)
    })
    it('object must contain at least one correctly-spelled property', () => {
      ...
      throws(() => {
        return inst.add({ hour: 12 })
      }, TypeError)
    })
    it('incorrectly-spelled properties are ignored', () => {
      equal(
        `${inst.add({ hour: 1, minutes: 1 })}`,
        '1969-12-25T12:24:45.678901234Z'
      )
    })
  })
  describe('Instant.subtract works', () => {
    ...
    it('inst.subtract(durationObj)', () => {
      const earlier = inst.subtract(
        Temporal.Duration.from('PT240H0.000000800S')
      )
      equal(`${earlier}`, '1969-12-15T12:23:45.678900434Z')
    })
    it('casts argument', () => {
      equal(
        `${inst.subtract('PT240H0.000000800S')}`,
        '1969-12-15T12:23:45.678900434Z'
      )
    })
    it('invalid to subtract years, months, weeks, or days', () => {
      throws(() => {
        return inst.subtract({ years: 1 })
      }, RangeError)
      throws(() => {
        return inst.subtract({ months: 1 })
      }, RangeError)
      throws(() => {
        return inst.subtract({ weeks: 1 })
      }, RangeError)
      throws(() => {
        return inst.subtract({ days: 1 })
      }, RangeError)
    })
    it('mixed positive and negative values always throw', () => {
      throws(() => {
        return inst.subtract({ hours: 1, minutes: -30 })
      }, RangeError)
    })
    it('object must contain at least one correctly-spelled property', () => {
      throws(() => {
        return inst.subtract({})
      }, TypeError)
      throws(() => {
        return inst.subtract({ hour: 12 })
      }, TypeError)
    })
    it('incorrectly-spelled properties are ignored', () => {
      equal(
        `${inst.subtract({ hour: 1, minutes: 1 })}`,
        '1969-12-25T12:22:45.678901234Z'
      )
    })
  })
  describe('Instant.compare works', () => {
    ...
    it('pre epoch equal', () => {
      return equal(Instant.compare(i1, Instant.from(i1)), 0)
    })
    it('epoch equal', () => {
      return equal(Instant.compare(i2, Instant.from(i2)), 0)
    })
    it('cross epoch smaller/larger', () => {
      return equal(Instant.compare(i1, i2), -1)
    })
    it('cross epoch larger/smaller', () => {
      return equal(Instant.compare(i2, i1), 1)
    })
    it('epoch smaller/larger', () => {
      return equal(Instant.compare(i2, i3), -1)
    })
    it('epoch larger/smaller', () => {
      return equal(Instant.compare(i3, i2), 1)
    })
    it('casts first argument', () => {
      return equal(Instant.compare(i1, i1.toString()), 0)
    })
    it('casts second argument', () => {
      return equal(Instant.compare(i2.toString(), i2), 0)
    })
    it('only casts from a string', () => {
      throws(() => {
        return Instant.compare(i2.epochNanoseconds, i2)
      }, RangeError)
      throws(() => {
        return Instant.compare({}, i2)
      }, RangeError)
    })
  })
  describe('Instant.equals works', () => {
    ...
    const i3 = Instant.from('1981-12-15T14:34:31.987654321Z')
    it('pre epoch equal', () => {
      return assert(i1.equals(i1))
    })
    it('epoch equal', () => {
      return assert(i2.equals(i2))
    })
    it('cross epoch unequal', () => {
      return assert(!i1.equals(i2))
    })
    it('epoch unequal', () => {
      return assert(!i2.equals(i3))
    })
    it('casts argument', () => {
      return assert(i1.equals('1963-02-13T09:36:29.123456789Z'))
    })
    it('casts only from string', () => {
      throws(() => {
        return i1.equals(i1.epochNanoseconds)
      }, RangeError)
      throws(() => {
        return i1.equals({})
      }, RangeError)
  ...
  describe('Instant.since() works', () => {
    ...
    it(`(${earlier}).since(${later}) == (${later}).since(${earlier}).negated()`, () => {
      return equal(`${earlier.since(later)}`, `${diff.negated()}`)
    })
    it(`(${later}).since(${earlier}) == (${earlier}).until(${later})`, () => {
      return equal(`${earlier.until(later)}`, `${diff}`)
    })
    ...
    it('only casts from a string', () => {
      throws(() => {
        return later.since(earlier.epochNanoseconds)
      }, RangeError)
      throws(() => {
        return earlier.since({})
      }, RangeError)
    })
    ...
    it('cannot return days, weeks, months, and years', () => {
      throws(() => {
        return feb21.since(feb20, { largestUnit: 'days' })
      }, RangeError)
      throws(() => {
        return feb21.since(feb20, { largestUnit: 'weeks' })
      }, RangeError)
      throws(() => {
        return feb21.since(feb20, { largestUnit: 'months' })
      }, RangeError)
      throws(() => {
        return feb21.since(feb20, { largestUnit: 'years' })
      }, RangeError)
    })
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
      ...
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(`${feb21.since(feb20, options)}`, 'PT31622400S')
      })
    })
  ...
  describe('Instant.until() works', () => {
    ...
    it(`(${later}).until(${earlier}) == (${earlier}).until(${later}).negated()`, () => {
      return equal(`${later.until(earlier)}`, `${diff.negated()}`)
    })
    it(`(${earlier}).until(${later}) == (${later}).since(${earlier})`, () => {
      return equal(`${later.since(earlier)}`, `${diff}`)
    })
    it(`(${earlier}).add(${diff}) == (${later})`, () => {
      return assert(earlier.add(diff).equals(later))
    })
    ...
    it('only casts from a string', () => {
      throws(() => {
        return earlier.until(later.epochNanoseconds)
      }, RangeError)
      throws(() => {
        return earlier.until({})
      }, RangeError)
    })
    const feb20 = Instant.from('2020-02-01T00:00Z')
    const feb21 = Instant.from('2021-02-01T00:00Z')
    it('defaults to returning seconds', () => {
      ...
      equal(
        `${feb20.until(Instant.from('2021-02-01T00:00:00.000000001Z'))}`,
        'PT31622400.000000001S'
      )
      equal(
        `${Instant.from('2020-02-01T00:00:00.000000001Z').until(feb21)}`,
        'PT31622399.999999999S'
      )
    })
    it('can return minutes and hours', () => {
    ...
    it('cannot return days, weeks, months, and years', () => {
      throws(() => {
        return feb20.until(feb21, { largestUnit: 'days' })
      }, RangeError)
      throws(() => {
        return feb20.until(feb21, { largestUnit: 'weeks' })
      }, RangeError)
      throws(() => {
        return feb20.until(feb21, { largestUnit: 'months' })
      }, RangeError)
      throws(() => {
        return feb20.until(feb21, { largestUnit: 'years' })
      }, RangeError)
    })
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
      ...
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(`${feb20.until(feb21, options)}`, 'PT31622400S')
      })
    })
    it('throws on disallowed or invalid smallestUnit', () => {
      ;[
  ...
  describe('Instant.round works', () => {
    ...
    it('throws without required smallestUnit parameter', () => {
      ...
      throws(() => {
        return inst.round({ roundingIncrement: 1, roundingMode: 'ceil' })
      }, RangeError)
    })
    it('throws on disallowed or invalid smallestUnit', () => {
      ;[
        ...
        throws(() => {
          return inst.round({ smallestUnit })
        }, RangeError)
      })
    })
    it('throws on invalid roundingMode', () => {
      throws(() => {
        return inst.round({ smallestUnit: 'second', roundingMode: 'cile' })
      }, RangeError)
    })
    const incrementOneNearest = [
    ...
    incrementOneNearest.forEach(([smallestUnit, expected]) => {
      it(`rounds to nearest ${smallestUnit}`, () => {
        return equal(
          `${inst.round({ smallestUnit, roundingMode: 'halfExpand' })}`,
          expected
        )
      })
    })
    ...
    incrementOneCeil.forEach(([smallestUnit, expected]) => {
      it(`rounds up to ${smallestUnit}`, () => {
        return equal(
          `${inst.round({ smallestUnit, roundingMode: 'ceil' })}`,
          expected
        )
      })
    })
    ...
    incrementOneFloor.forEach(([smallestUnit, expected]) => {
      it(`rounds down to ${smallestUnit}`, () => {
        return equal(
          `${inst.round({ smallestUnit, roundingMode: 'floor' })}`,
          expected
        )
      })
      it(`truncates to ${smallestUnit}`, () => {
        return equal(
          `${inst.round({ smallestUnit, roundingMode: 'trunc' })}`,
          expected
        )
      })
    })
    ...
    it('rounding down is towards the Big Bang, not towards the epoch', () => {
      ...
      equal(
        `${inst2.round({ smallestUnit, roundingMode: 'ceil' })}`,
        '1969-12-15T12:00:01Z'
      )
      equal(
        `${inst2.round({ smallestUnit, roundingMode: 'floor' })}`,
        '1969-12-15T12:00:00Z'
      )
      equal(
        `${inst2.round({ smallestUnit, roundingMode: 'trunc' })}`,
        '1969-12-15T12:00:00Z'
      )
      equal(
        `${inst2.round({ smallestUnit, roundingMode: 'halfExpand' })}`,
        '1969-12-15T12:00:01Z'
      )
    })
    it('rounds to an increment of hours', () => {
      equal(
        `${inst.round({ smallestUnit: 'hour', roundingIncrement: 4 })}`,
        '1976-11-18T16:00:00Z'
      )
    })
    it('rounds to an increment of minutes', () => {
      equal(
        `${inst.round({ smallestUnit: 'minute', roundingIncrement: 15 })}`,
        '1976-11-18T14:30:00Z'
      )
    })
    it('rounds to an increment of seconds', () => {
      equal(
        `${inst.round({ smallestUnit: 'second', roundingIncrement: 30 })}`,
        '1976-11-18T14:23:30Z'
      )
    })
    it('rounds to an increment of milliseconds', () => {
      equal(
        `${inst.round({ smallestUnit: 'millisecond', roundingIncrement: 10 })}`,
        '1976-11-18T14:23:30.12Z'
      )
    })
    it('rounds to an increment of microseconds', () => {
      equal(
        `${inst.round({ smallestUnit: 'microsecond', roundingIncrement: 10 })}`,
        '1976-11-18T14:23:30.12346Z'
      )
    })
    it('rounds to an increment of nanoseconds', () => {
      equal(
        `${inst.round({ smallestUnit: 'nanosecond', roundingIncrement: 10 })}`,
    ...
    it('rounds to days by specifying increment of 86400 seconds in various units', () => {
      ...
      equal(
        `${inst.round({ smallestUnit: 'hour', roundingIncrement: 24 })}`,
        expected
      )
      equal(
        `${inst.round({ smallestUnit: 'minute', roundingIncrement: 1440 })}`,
        expected
      )
      equal(
        `${inst.round({ smallestUnit: 'second', roundingIncrement: 86400 })}`,
        expected
      )
      equal(
        `${inst.round({
          smallestUnit: 'millisecond',
          roundingIncrement: 86400e3,
        })}`,
        expected
      )
      equal(
    ...
    it('throws on increments that do not divide evenly into solar days', () => {
      throws(() => {
        return inst.round({ smallestUnit: 'hour', roundingIncrement: 7 })
      }, RangeError)
      throws(() => {
        return inst.round({ smallestUnit: 'minute', roundingIncrement: 29 })
      }, RangeError)
      throws(() => {
        return inst.round({ smallestUnit: 'second', roundingIncrement: 29 })
      }, RangeError)
      throws(() => {
        return inst.round({
          smallestUnit: 'millisecond',
      ...
      throws(() => {
        return inst.round({ smallestUnit: 'nanosecond', roundingIncrement: 29 })
      }, RangeError)
    })
    it('accepts plural units', () => {
      assert(
        inst
          ...
          .equals(inst.round({ smallestUnit: 'hour' }))
      )
      assert(
        inst
          .round({ smallestUnit: 'minutes' })
          .equals(inst.round({ smallestUnit: 'minute' }))
      )
      assert(
        inst
          .round({ smallestUnit: 'seconds' })
          .equals(inst.round({ smallestUnit: 'second' }))
      )
      assert(
        inst
          .round({ smallestUnit: 'milliseconds' })
          .equals(inst.round({ smallestUnit: 'millisecond' }))
      )
      assert(
        inst
          .round({ smallestUnit: 'microseconds' })
          .equals(inst.round({ smallestUnit: 'microsecond' }))
      )
      assert(
        inst
          .round({ smallestUnit: 'nanoseconds' })
          .equals(inst.round({ smallestUnit: 'nanosecond' }))
      )
    })
  })
  describe('Min/max range', () => {
    ...
    it('constructing from ms', () => {
      ...
      throws(() => {
        return Instant.fromEpochMilliseconds(-limit - 1)
      }, RangeError)
      throws(() => {
        return Instant.fromEpochMilliseconds(limit + 1)
      }, RangeError)
      equal(
        `${Instant.fromEpochMilliseconds(-limit)}`,
    ...
    it('constructing from ISO string', () => {
      throws(() => {
        return Instant.from('-271821-04-19T23:59:59.999999999Z')
      }, RangeError)
      throws(() => {
        return Instant.from('+275760-09-13T00:00:00.000000001Z')
      }, RangeError)
      equal(
        `${Instant.from('-271821-04-20T00:00Z')}`,
        '-271821-04-20T00:00:00Z'
      )
      equal(
        `${Instant.from('+275760-09-13T00:00Z')}`,
        '+275760-09-13T00:00:00Z'
      )
    })
    it('converting from DateTime', () => {
      ...
      throws(() => {
        return utc.getInstantFor(min)
      }, RangeError)
      throws(() => {
        return utc.getInstantFor(max)
      }, RangeError)
    })
    it('adding and subtracting beyond limit', () => {
      ...
      throws(() => {
        return min.subtract({ nanoseconds: 1 })
      }, RangeError)
      throws(() => {
        return max.add({ nanoseconds: 1 })
      }, RangeError)
    })
  })
  describe('Instant.toZonedDateTimeISO() works', () => {
    ...
    it('throws without parameter', () => {
      throws(() => {
        return inst.toZonedDateTimeISO()
      }, RangeError)
    })
  ...
  describe('Instant.toZonedDateTime() works', () => {
    ...
    it('throws without parameter', () => {
      throws(() => {
        return inst.toZonedDateTime()
      }, TypeError)
    })
    it('throws with a string parameter', () => {
      throws(() => {
        return inst.toZonedDateTime('Asia/Singapore')
      }, TypeError)
    })
    it('time zone parameter UTC', () => {
      const timeZone = Temporal.TimeZone.from('UTC')
    ...
    it('time zone parameter non-UTC', () => {
      ...
      equal(
        `${zdt}`,
        '1976-11-18T09:23:30.123456789-05:00[America/New_York][u-ca=gregory]'
      )
    })
  })
})
