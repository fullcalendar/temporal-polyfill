...
describe.skip('YearMonth', () => {
  ...
  describe('Construction', () => {
    ...
    it('ym.year is 1976', () => {
      return equal(ym.year, 1976)
    })
    it('ym.month is 11', () => {
      return equal(ym.month, 11)
    })
    it('ym.monthCode is "M11"', () => {
      return equal(ym.monthCode, 'M11')
    })
    it('ym.daysInMonth is 30', () => {
      return equal(ym.daysInMonth, 30)
    })
    it('ym.daysInYear is 366', () => {
      return equal(ym.daysInYear, 366)
    })
    it('ym.monthsInYear is 12', () => {
      return equal(ym.monthsInYear, 12)
    })
    describe('.from()', () => {
      it('YearMonth.from(2019-10) == 2019-10', () => {
        return equal(`${PlainYearMonth.from('2019-10')}`, '2019-10')
      })
      it('YearMonth.from(2019-10-01T09:00:00Z) == 2019-10', () => {
        return equal(
          `${PlainYearMonth.from('2019-10-01T09:00:00Z')}`,
          '2019-10'
        )
      })
      it("YearMonth.from('1976-11') == (1976-11)", () => {
        return equal(`${PlainYearMonth.from('1976-11')}`, '1976-11')
      })
      it("YearMonth.from('1976-11-18') == (1976-11)", () => {
        return equal(`${PlainYearMonth.from('1976-11-18')}`, '1976-11')
      })
      it('can be constructed with monthCode and without month', () => {
        return equal(
          `${PlainYearMonth.from({ year: 2019, monthCode: 'M11' })}`,
          '2019-11'
        )
      })
      it('can be constructed with month and without monthCode', () => {
        return equal(
          `${PlainYearMonth.from({ year: 2019, month: 11 })}`,
          '2019-11'
        )
      })
      ...
      it('YearMonth.from({ year: 2019 }) throws', () => {
        return throws(() => {
          return PlainYearMonth.from({ year: 2019 })
        }, TypeError)
      })
      it('YearMonth.from({ month: 6 }) throws', () => {
        return throws(() => {
          return PlainYearMonth.from({ month: 6 })
        }, TypeError)
      })
      it('YearMonth.from({ monthCode: "M06" }) throws', () => {
        return throws(() => {
          return PlainYearMonth.from({ monthCode: 'M06' })
        }, TypeError)
      })
      ...
      it('YearMonth.from(required prop undefined) throws', () => {
        return throws(() => {
          return PlainYearMonth.from({ year: undefined, month: 6 })
        }, TypeError)
      })
      it('YearMonth.from(number) is converted to string', () => {
        return assert(
          PlainYearMonth.from(201906).equals(PlainYearMonth.from('201906'))
        )
      })
      it('basic format', () => {
      ...
      it('variant minus sign', () => {
        ...
        equal(
          `${PlainYearMonth.from('1976-11-18T15:23:30.1\u221202:00')}`,
          '1976-11'
        )
      })
      it('mixture of basic and extended format', () => {
        ...
        equal(
          `${PlainYearMonth.from('+001976-11-18T152330.1+00:00')}`,
          '1976-11'
        )
        equal(
          `${PlainYearMonth.from('+0019761118T15:23:30.1+00:00')}`,
          '1976-11'
        )
        equal(
          `${PlainYearMonth.from('+001976-11-18T15:23:30.1+0000')}`,
          '1976-11'
        )
        equal(
          `${PlainYearMonth.from('+001976-11-18T152330.1+0000')}`,
          '1976-11'
        )
        equal(
          `${PlainYearMonth.from('+0019761118T15:23:30.1+0000')}`,
          '1976-11'
        )
      ...
      it('no junk at end of string', () => {
        return throws(() => {
          return PlainYearMonth.from('1976-11junk')
        }, RangeError)
      })
      it('options may only be an object or undefined', () => {
        ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
          return throws(() => {
            return PlainYearMonth.from({ year: 1976, month: 11 }, badOptions)
          }, TypeError)
        })
        ;[{}, () => {}, undefined].forEach((options) => {
          return equal(
            `${PlainYearMonth.from({ year: 1976, month: 11 }, options)}`,
            '1976-11'
          )
        })
      })
      describe('Overflow', () => {
        ...
        it('reject', () => {
          return throws(() => {
            return PlainYearMonth.from(bad, { overflow: 'reject' })
          }, RangeError)
        })
        it('constrain', () => {
          equal(`${PlainYearMonth.from(bad)}`, '2019-12')
          equal(
            `${PlainYearMonth.from(bad, { overflow: 'constrain' })}`,
            '2019-12'
          )
        })
        it('throw on bad overflow', () => {
          ;[
            ...
            ;['', 'CONSTRAIN', 'balance', 3, null].forEach((overflow) => {
              return throws(() => {
                return PlainYearMonth.from(input, { overflow })
              }, RangeError)
            })
          })
        })
        it('constrain has no effect on invalid ISO string', () => {
          throws(() => {
            return PlainYearMonth.from('2020-13', { overflow: 'constrain' })
          }, RangeError)
        })
      })
      it('object must contain at least the required correctly-spelled properties', () => {
        ...
        throws(() => {
          return PlainYearMonth.from({ year: 1976, months: 11 })
        }, TypeError)
      })
      it('incorrectly-spelled properties are ignored', () => {
        equal(
          `${PlainYearMonth.from({ year: 1976, month: 11, months: 12 })}`,
          '1976-11'
        )
      })
    })
    describe('.with()', () => {
      ...
      it('with(2020)', () => {
        return equal(`${ym.with({ year: 2020 })}`, '2020-10')
      })
      it('with(09)', () => {
        return equal(`${ym.with({ month: 9 })}`, '2019-09')
      })
      it('with(monthCode)', () => {
        return equal(`${ym.with({ monthCode: 'M09' })}`, '2019-09')
      })
      it('month and monthCode must agree', () => {
        return throws(() => {
          return ym.with({ month: 9, monthCode: 'M10' })
        }, RangeError)
      })
    })
  })
  describe('YearMonth.with() works', () => {
    ...
    it('throws with calendar property', () => {
      throws(() => {
        return ym.with({ year: 2021, calendar: 'iso8601' })
      }, TypeError)
    })
    it('throws with timeZone property', () => {
      throws(() => {
        return ym.with({ year: 2021, timeZone: 'UTC' })
      }, TypeError)
    })
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return ym.with({ year: 2020 }, badOptions)
        }, TypeError)
      })
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(`${ym.with({ year: 2020 }, options)}`, '2020-10')
      })
    })
    ...
    it('day is ignored when determining ISO reference day', () => {
      equal(
        ym.with({ year: ym.year, day: 31 }).getISOFields().isoDay,
        ym.getISOFields().isoDay
      )
    })
  })
  describe('YearMonth.compare() works', () => {
    ...
    it('equal', () => {
      return equal(PlainYearMonth.compare(nov94, nov94), 0)
    })
    it('smaller/larger', () => {
      return equal(PlainYearMonth.compare(nov94, jun13), -1)
    })
    it('larger/smaller', () => {
      return equal(PlainYearMonth.compare(jun13, nov94), 1)
    })
    ...
    it('object must contain at least the required properties', () => {
      throws(() => {
        return PlainYearMonth.compare({ year: 1994 }, jun13)
      }, TypeError)
      throws(() => {
        return PlainYearMonth.compare(nov94, { year: 2013 })
      }, TypeError)
    })
  ...
  describe('YearMonth.equals() works', () => {
    ...
    const jun13 = PlainYearMonth.from('2013-06')
    it('equal', () => {
      return assert(nov94.equals(nov94))
    })
    it('unequal', () => {
      return assert(!nov94.equals(jun13))
    })
    it('casts argument', () => {
  ...
  describe("Comparison operators don't work", () => {
    ...
    it('=== is object equality', () => {
      return equal(ym1, ym1)
    })
    it('!== is object equality', () => {
      return notEqual(ym1, ym1again)
    })
    it('<', () => {
      return throws(() => {
        return ym1 < ym2
  ...
  describe('YearMonth.until() works', () => {
    ...
    it(`${jun13}.until(${nov94}) == ${nov94}.until(${jun13}).negated()`, () => {
      return equal(`${jun13.until(nov94)}`, `${diff.negated()}`)
    })
    it(`${nov94}.add(${diff}) == ${jun13}`, () => {
      return nov94.add(diff).equals(jun13)
    })
    it(`${jun13}.subtract(${diff}) == ${nov94}`, () => {
      return jun13.subtract(diff).equals(nov94)
    })
    it(`${nov94}.until(${jun13}) == ${jun13}.since(${nov94})`, () => {
      return equal(`${diff}`, `${jun13.since(nov94)}`)
    })
    it('casts argument', () => {
    ...
    it('cannot return lower units', () => {
      ...
      throws(() => {
        return feb20.until(feb21, { largestUnit: 'hours' })
      }, RangeError)
      throws(() => {
        return feb20.until(feb21, { largestUnit: 'minutes' })
      }, RangeError)
      throws(() => {
        return feb20.until(feb21, { largestUnit: 'seconds' })
      }, RangeError)
      throws(() => {
        return feb20.until(feb21, { largestUnit: 'milliseconds' })
      }, RangeError)
      throws(() => {
        return feb20.until(feb21, { largestUnit: 'microseconds' })
      }, RangeError)
      throws(() => {
        return feb20.until(feb21, { largestUnit: 'nanoseconds' })
      }, RangeError)
    })
    ...
    it('options may only be an object or undefined', () => {
      ...
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(`${feb20.until(feb21, options)}`, 'P1Y')
      })
    })
  ...
  describe('YearMonth.since() works', () => {
    ...
    it(`${nov94}.since(${jun13}) == ${jun13}.since(${nov94}).negated()`, () => {
      return equal(`${nov94.since(jun13)}`, `${diff.negated()}`)
    })
    it(`${nov94}.add(${diff}) == ${jun13}`, () => {
      return nov94.add(diff).equals(jun13)
    })
    ...
    it(`${jun13}.since(${nov94}) == ${nov94}.until(${jun13})`, () => {
      return equal(`${diff}`, `${nov94.until(jun13)}`)
    })
    it('casts argument', () => {
    ...
    it('cannot return lower units', () => {
      ...
      throws(() => {
        return feb21.since(feb20, { largestUnit: 'hours' })
      }, RangeError)
      throws(() => {
        return feb21.since(feb20, { largestUnit: 'minutes' })
      }, RangeError)
      throws(() => {
        return feb21.since(feb20, { largestUnit: 'seconds' })
      }, RangeError)
      throws(() => {
        return feb21.since(feb20, { largestUnit: 'milliseconds' })
      }, RangeError)
      throws(() => {
        return feb21.since(feb20, { largestUnit: 'microseconds' })
      }, RangeError)
      throws(() => {
        return feb21.since(feb20, { largestUnit: 'nanoseconds' })
      }, RangeError)
    })
    it('no two different calendars', () => {
      const ym1 = new PlainYearMonth(2000, 1)
    ...
    it('options may only be an object or undefined', () => {
      ...
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(`${feb21.since(feb20, options)}`, 'P1Y')
      })
    })
    const earlier = PlainYearMonth.from('2019-01')
    const later = PlainYearMonth.from('2021-09')
  ...
  describe('YearMonth.add() works', () => {
    ...
    it('casts argument', () => {
      return equal(`${ym.add('P2M')}`, '2020-01')
    })
    ...
    it('invalid overflow', () => {
      ;['', 'CONSTRAIN', 'balance', 3, null].forEach((overflow) => {
        return throws(() => {
          return ym.add({ months: 1 }, { overflow })
        }, RangeError)
      })
    })
    it('mixed positive and negative values always throw', () => {
      ;['constrain', 'reject'].forEach((overflow) => {
        return throws(() => {
          return ym.add({ years: 1, months: -6 }, { overflow })
        }, RangeError)
      })
    })
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return ym.add({ months: 1 }, badOptions)
        }, TypeError)
      })
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(`${ym.add({ months: 1 }, options)}`, '2019-12')
      })
    })
    it('object must contain at least one correctly-spelled property', () => {
      throws(() => {
  ...
  describe('YearMonth.subtract() works', () => {
    ...
    it('(2019-11) minus 11 months === 2018-12', () => {
      ...
      equal(
        `${ym.subtract({ months: 11 }, { overflow: 'constrain' })}`,
        '2018-12'
      )
    ...
    it('(2019-11) minus 12 years === 2007-11', () => {
      ...
      equal(
        `${ym.subtract({ years: 12 }, { overflow: 'constrain' })}`,
        '2007-11'
      )
    ...
    it('symmetrical with regard to negative durations', () => {
      equal(
        `${PlainYearMonth.from('2018-12').subtract({ months: -11 })}`,
        '2019-11'
      )
      equal(
        `${PlainYearMonth.from('2007-11').subtract({ years: -12 })}`,
        '2019-11'
      )
    })
    ...
    it('casts argument', () => {
      return equal(`${ym.subtract('P11M')}`, '2018-12')
    })
    it("ignores lower units that don't balance up to the length of the month", () => {
    ...
    it('balances days to months based on the number of days in the ISO month', () => {
      equal(
        `${PlainYearMonth.from('2019-02').subtract({ days: 27 })}`,
        '2019-02'
      )
      equal(
        `${PlainYearMonth.from('2019-02').subtract({ days: 28 })}`,
        '2019-01'
      )
      equal(
        `${PlainYearMonth.from('2020-02').subtract({ days: 28 })}`,
        '2020-02'
      )
      equal(
        `${PlainYearMonth.from('2020-02').subtract({ days: 29 })}`,
        '2020-01'
      )
      equal(
        `${PlainYearMonth.from('2019-11').subtract({ days: 29 })}`,
        '2019-11'
      )
      equal(
        `${PlainYearMonth.from('2019-11').subtract({ days: 30 })}`,
        '2019-10'
      )
      equal(
        `${PlainYearMonth.from('2020-01').subtract({ days: 30 })}`,
        '2020-01'
      )
      equal(
        `${PlainYearMonth.from('2020-01').subtract({ days: 31 })}`,
        '2019-12'
      )
    })
    it('invalid overflow', () => {
      ;['', 'CONSTRAIN', 'balance', 3, null].forEach((overflow) => {
        return throws(() => {
          return ym.subtract({ months: 1 }, { overflow })
        }, RangeError)
      })
    })
    it('mixed positive and negative values always throw', () => {
      ;['constrain', 'reject'].forEach((overflow) => {
        return throws(() => {
          return ym.subtract({ years: 1, months: -6 }, { overflow })
        }, RangeError)
      })
    })
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return ym.subtract({ months: 1 }, badOptions)
        }, TypeError)
      })
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(`${ym.subtract({ months: 1 }, options)}`, '2019-10')
      })
    })
    it('object must contain at least one correctly-spelled property', () => {
      throws(() => {
  ...
  describe('Min/max range', () => {
    it('constructing from numbers', () => {
      throws(() => {
        return new PlainYearMonth(-271821, 3)
      }, RangeError)
      throws(() => {
        return new PlainYearMonth(275760, 10)
      }, RangeError)
    ...
    it('constructing from property bag', () => {
      ...
      ;['reject', 'constrain'].forEach((overflow) => {
        ;[tooEarly, tooLate].forEach((props) => {
          throws(() => {
            return PlainYearMonth.from(props, { overflow })
          }, RangeError)
        })
      })
    ...
    it('constructing from ISO string', () => {
      ;['reject', 'constrain'].forEach((overflow) => {
        ;['-271821-03', '+275760-10'].forEach((str) => {
          throws(() => {
            return PlainYearMonth.from(str, { overflow })
          }, RangeError)
        })
      })
    ...
    it('adding and subtracting beyond limit', () => {
      ...
      ;['reject', 'constrain'].forEach((overflow) => {
        throws(() => {
          return min.subtract({ months: 1 }, { overflow })
        }, RangeError)
        throws(() => {
          return max.add({ months: 1 }, { overflow })
        }, RangeError)
      })
    })
  })
  describe('YearMonth.with()', () => {
    it('throws on bad overflow', () => {
      ;['', 'CONSTRAIN', 'balance', 3, null].forEach((overflow) => {
        return throws(() => {
          return PlainYearMonth.from({ year: 2019, month: 1 }).with(
            { month: 2 },
            { overflow }
          )
        }, RangeError)
  ...
  describe('YearMonth.toPlainDate()', () => {
    ...
    it('needs at least a day property on the object in the ISO calendar', () => {
      throws(() => {
        return ym.toPlainDate({ something: 'nothing' })
      }, TypeError)
    })
  })
  describe('YearMonth.toString()', () => {
    const ym1 = PlainYearMonth.from('1976-11')
    const ym2 = PlainYearMonth.from({
      year: 1976,
      month: 11,
      calendar: 'gregory',
    })
    ...
    it('throws on invalid calendar', () => {
      ;['ALWAYS', 'sometimes', false, 3, null].forEach((calendarName) => {
        throws(() => {
          return ym1.toString({ calendarName })
        }, RangeError)
      })
    })
  })
