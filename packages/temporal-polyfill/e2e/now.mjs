...
describe.skip('Temporal.Now', () => {
  describe('Structure', () => {
    ...
    it('Temporal.Now has 9 properties', () => {
      return equal(Object.keys(Temporal.Now).length, 9)
    })
    it('Temporal.Now.instant is a function', () => {
      return equal(typeof Temporal.Now.instant, 'function')
    })
    it('Temporal.Now.plainDateTime is a function', () => {
      return equal(typeof Temporal.Now.plainDateTime, 'function')
    })
    it('Temporal.Now.plainDateTimeISO is a function', () => {
      return equal(typeof Temporal.Now.plainDateTimeISO, 'function')
    })
    it('Temporal.Now.plainDate is a function', () => {
      return equal(typeof Temporal.Now.plainDate, 'function')
    })
    it('Temporal.Now.plainDateISO is a function', () => {
      return equal(typeof Temporal.Now.plainDateISO, 'function')
    })
    it('Temporal.Now.plainTimeISO is a function', () => {
      return equal(typeof Temporal.Now.plainTimeISO, 'function')
    })
    it('Temporal.Now.timeZone is a function', () => {
      return equal(typeof Temporal.Now.timeZone, 'function')
    })
    it('Temporal.Now.zonedDateTimeISO is a function', () => {
      return equal(typeof Temporal.Now.zonedDateTimeISO, 'function')
    })
    it('Temporal.Now.zonedDateTime is a function', () => {
      return equal(typeof Temporal.Now.zonedDateTime, 'function')
    })
  })
  describe('Temporal.Now.instant()', () => {
    it('Temporal.Now.instant() returns an Instant', () => {
      return assert(Temporal.Now.instant() instanceof Temporal.Instant)
    })
  })
  ...
  describe('Temporal.Now.plainDateTime()', () => {
    ...
    it('requires a calendar', () => {
      return throws(() => {
        return Temporal.Now.plainDateTime()
      }, RangeError)
    })
  })
  ...
  describe('Temporal.Now.zonedDateTime()', () => {
    ...
    it('requires a calendar', () => {
      return throws(() => {
        return Temporal.Now.zonedDateTime()
      }, RangeError)
    })
  })
