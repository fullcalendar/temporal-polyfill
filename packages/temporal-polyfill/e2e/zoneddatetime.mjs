...
describe('ZonedDateTime', () => {
  ...
  describe('Construction and properties', () => {
    ...
    describe('ZonedDateTime for (1976, 11, 18, 15, 23, 30, 123, 456, 789)', () => {
      ...
      it('zdt.year is 1976', () => {
        return equal(zdt.year, 1976)
      })
      it('zdt.month is 11', () => {
        return equal(zdt.month, 11)
      })
      it('zdt.monthCode is "M11"', () => {
        return equal(zdt.monthCode, 'M11')
      })
      it('zdt.day is 18', () => {
        return equal(zdt.day, 18)
      })
      it('zdt.hour is 15', () => {
        return equal(zdt.hour, 15)
      })
      it('zdt.minute is 23', () => {
        return equal(zdt.minute, 23)
      })
      it('zdt.second is 30', () => {
        return equal(zdt.second, 30)
      })
      it('zdt.millisecond is 123', () => {
        return equal(zdt.millisecond, 123)
      })
      it('zdt.microsecond is 456', () => {
        return equal(zdt.microsecond, 456)
      })
      it('zdt.nanosecond is 789', () => {
        return equal(zdt.nanosecond, 789)
      })
      it('zdt.epochSeconds is 217178610', () => {
        return equal(zdt.epochSeconds, 217178610)
      })
      it('zdt.epochMilliseconds is 217178610123', () => {
        return equal(zdt.epochMilliseconds, 217178610123)
      })
      it('zdt.epochMicroseconds is 217178610123456n', () => {
        return equal(zdt.epochMicroseconds, 217178610123456n)
      })
      it('zdt.epochNanoseconds is 217178610123456789n', () => {
        return equal(zdt.epochNanoseconds, 217178610123456789n)
      })
      it('zdt.dayOfWeek is 4', () => {
        return equal(zdt.dayOfWeek, 4)
      })
      it('zdt.dayOfYear is 323', () => {
        return equal(zdt.dayOfYear, 323)
      })
      it('zdt.weekOfYear is 47', () => {
        return equal(zdt.weekOfYear, 47)
      })
      it('zdt.daysInWeek is 7', () => {
        return equal(zdt.daysInWeek, 7)
      })
      it('zdt.daysInMonth is 30', () => {
        return equal(zdt.daysInMonth, 30)
      })
      it('zdt.daysInYear is 366', () => {
        return equal(zdt.daysInYear, 366)
      })
      it('zdt.monthsInYear is 12', () => {
        return equal(zdt.monthsInYear, 12)
      })
      it('zdt.inLeapYear is true', () => {
        return equal(zdt.inLeapYear, true)
      })
      it('zdt.offset is +00:00', () => {
        return equal(zdt.offset, '+00:00')
      })
      it('zdt.offsetNanoseconds is 0', () => {
        return equal(zdt.offsetNanoseconds, 0)
      })
      it('string output is 1976-11-18T15:23:30.123456789+00:00[UTC]', () => {
        return equal(`${zdt}`, '1976-11-18T15:23:30.123456789+00:00[UTC]')
      })
    })
    describe('ZonedDateTime with non-UTC time zone and non-ISO calendar', () => {
      ...
      it('zdt.offset is +01:00', () => {
        return equal(zdt.offset, '+01:00')
      })
      it('zdt.offsetNanoseconds is 3600e9', () => {
        return equal(zdt.offsetNanoseconds, 3600e9)
      })
  ...
  describe('string parsing', () => {
    ...
    it('parses with an IANA zone but no offset (with disambiguation)', () => {
      const zdt = ZonedDateTime.from('2020-03-08T02:30[America/Los_Angeles]', {
    ...
    it('throws if no brackets', () => {
      throws(() => {
        return ZonedDateTime.from('2020-03-08T01:00-08:00')
      }, RangeError)
      throws(() => {
        return ZonedDateTime.from('2020-03-08T01:00Z')
      }, RangeError)
    })
    it('"Z" is a time zone designation, not an offset', () => {
      throws(() => {
        return ZonedDateTime.from('2020-03-08T09:00:00Z[America/Los_Angeles]')
      }, RangeError)
    })
    ...
    it('variant time separators', () => {
      ;[
        '1976-11-18t15:23-08:00[America/Los_Angeles]',
        '1976-11-18 15:23-08:00[America/Los_Angeles]',
      ].forEach((input) => {
        return equal(
          `${ZonedDateTime.from(input)}`,
          '1976-11-18T15:23:00-08:00[America/Los_Angeles]'
        )
      })
    })
    ...
    it('optional parts', () => {
      ...
      equal(
        `${ZonedDateTime.from('2020-01-01[Asia/Tokyo]')}`,
    ...
    it('no junk at end of string', () => {
      return throws(() => {
        return ZonedDateTime.from(
          '1976-11-18T15:23:30.123456789-08:00[America/Los_Angeles]junk'
        )
      }, RangeError)
    })
    it('constrain has no effect on invalid ISO string', () => {
      throws(() => {
        return ZonedDateTime.from('2020-13-34T24:60[America/Los_Angeles]', {
          overflow: 'constrain',
        })
      }, RangeError)
    })
    describe('Offset option', () => {
      it("{ offset: 'reject' } throws if offset does not match offset time zone", () => {
        throws(() => {
          return ZonedDateTime.from('2020-03-08T01:00-04:00[-08:00]')
        }, RangeError)
        throws(() => {
          return ZonedDateTime.from('2020-03-08T01:00-04:00[-08:00]', {
            offset: 'reject',
      ...
      it("{ offset: 'reject' } throws if offset does not match IANA time zone", () => {
        throws(() => {
          return ZonedDateTime.from('2020-03-08T01:00-04:00[America/Chicago]')
        }, RangeError)
        throws(() => {
          return ZonedDateTime.from('2020-03-08T01:00-04:00[America/Chicago]', {
            offset: 'reject',
    ...
    describe('Disambiguation option', () => {
      it('plain datetime with multiple instants - Fall DST in Brazil', () => {
        ...
        throws(() => {
          return ZonedDateTime.from(str, { disambiguation: 'reject' })
        }, RangeError)
      })
      ...
      it('uses disambiguation if offset is ignored', () => {
        ...
        throws(() => {
          return ZonedDateTime.from(str, { offset, disambiguation: 'reject' })
        }, RangeError)
      })
      ...
      it('throw when bad disambiguation', () => {
        ;['', 'EARLIER', 'balance', 3, null].forEach((disambiguation) => {
          throws(() => {
            return ZonedDateTime.from('2020-11-01T04:00[America/Los_Angeles]', {
              disambiguation,
            })
          }, RangeError)
        })
  ...
  describe('property bags', () => {
    ...
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return ZonedDateTime.from(
            { year: 1976, month: 11, day: 18, timeZone: lagos },
            badOptions
          )
        }, TypeError)
      })
    ...
    describe('Overflow option', () => {
      ...
      it('reject', () => {
        return throws(() => {
          return ZonedDateTime.from(bad, { overflow: 'reject' })
        }, RangeError)
      })
      it('constrain', () => {
        equal(
          `${ZonedDateTime.from(bad)}`,
          '2019-01-31T00:00:00+01:00[Africa/Lagos]'
        )
        equal(
          `${ZonedDateTime.from(bad, { overflow: 'constrain' })}`,
          '2019-01-31T00:00:00+01:00[Africa/Lagos]'
        )
      })
      it('throw when bad overflow', () => {
        ;['', 'CONSTRAIN', 'balance', 3, null].forEach((overflow) => {
          throws(() => {
            return ZonedDateTime.from(
              { year: 2019, month: 1, day: 1, timeZone: lagos },
              { overflow }
            )
          }, RangeError)
        })
      ...
      it('reject leap second', () => {
        return throws(() => {
          return ZonedDateTime.from(leap, { overflow: 'reject' })
        }, RangeError)
      })
      it('constrain leap second', () => {
        return equal(
          `${ZonedDateTime.from(leap)}`,
          '2016-12-31T23:59:59+01:00[Africa/Lagos]'
        )
      })
    })
    describe('Offset option', () => {
      it("{ offset: 'reject' } throws if offset does not match offset time zone", () => {
        ...
        throws(() => {
          return ZonedDateTime.from(obj, { offset: 'reject' })
        }, RangeError)
      })
      it("{ offset: 'reject' } throws if offset does not match IANA time zone", () => {
        const obj = {
      ...
      it("{ offset: 'prefer' } if offset matches time zone (first 1:30 when DST ends)", () => {
        ...
        equal(
          `${ZonedDateTime.from(obj, { offset: 'prefer' })}`,
      ...
      it("{ offset: 'ignore' } uses time zone only", () => {
        ...
        equal(
          `${ZonedDateTime.from(obj, { offset: 'ignore' })}`,
          '2020-11-01T04:00:00-08:00[America/Los_Angeles]'
        )
      })
      it("{ offset: 'use' } uses offset only", () => {
        const obj = { ...date, hour: 4, offset: '-07:00' }
        equal(
          `${ZonedDateTime.from(obj, { offset: 'use' })}`,
    ...
    describe('Disambiguation option', () => {
      it('plain datetime with multiple instants - Fall DST in Brazil', () => {
        ...
        throws(() => {
          return ZonedDateTime.from(obj, { disambiguation: 'reject' })
        }, RangeError)
      })
      it('plain datetime with multiple instants - Spring DST in Los Angeles', () => {
        const cali = Temporal.TimeZone.from('America/Los_Angeles')
      ...
      it('uses disambiguation if offset is wrong and option is prefer', () => {
        ...
        throws(() => {
          return ZonedDateTime.from(obj, { offset, disambiguation: 'reject' })
        }, RangeError)
      })
      it('throw when bad disambiguation', () => {
        ;['', 'EARLIER', 'balance', 3, null].forEach((disambiguation) => {
  ...
  describe('ZonedDateTime.with()', () => {
    const zdt = new Temporal.PlainDateTime(
      1976,
      11,
      18,
      15,
    ...
    it('month and monthCode must agree', () => {
      throws(() => {
        return zdt.with({ month: 5, monthCode: 'M06' })
      }, RangeError)
    })
    ...
    describe('Overflow', () => {
      it('constrain', () => {
        ...
        equal(
          ...
          '1976-11-30T15:23:30.123456789+00:00[UTC]'
        )
        equal(
          `${zdt.with({ hour: 29 }, { overflow })}`,
          '1976-11-18T23:23:30.123456789+00:00[UTC]'
        )
        equal(
          `${zdt.with({ nanosecond: 9000 }, { overflow })}`,
          '1976-11-18T15:23:30.123456999+00:00[UTC]'
        )
      })
      it('reject', () => {
        const overflow = 'reject'
        throws(() => {
          return zdt.with({ month: 29 }, { overflow })
        }, RangeError)
        throws(() => {
          return zdt.with({ day: 31 }, { overflow })
        }, RangeError)
        throws(() => {
          return zdt.with({ hour: 29 }, { overflow })
        }, RangeError)
        throws(() => {
          return zdt.with({ nanosecond: 9000 }, { overflow })
        }, RangeError)
      })
      it('constrain is the default', () => {
        equal(
          `${zdt.with({ month: 29 })}`,
          `${zdt.with({ month: 29 }, { overflow: 'constrain' })}`
        )
      })
      it('invalid overflow', () => {
        ;['', 'CONSTRAIN', 'balance', 3, null].forEach((overflow) => {
          return throws(() => {
            return zdt.with({ day: 5 }, { overflow })
          }, RangeError)
        })
      })
    })
    const dstStartDay = ZonedDateTime.from(
      '2019-03-10T12:00:01-02:30[America/St_Johns]'
    )
    const dstEndDay = ZonedDateTime.from(
      '2019-11-03T12:00:01-03:30[America/St_Johns]'
    )
    ...
    describe('Disambiguation option', () => {
      ...
      it('reject', () => {
        throws(() => {
          return dstStartDay.with(twoThirty, {
            offset,
            disambiguation: 'reject',
          })
        }, RangeError)
        throws(() => {
          return dstEndDay.with(oneThirty, { offset, disambiguation: 'reject' })
        }, RangeError)
      })
      ...
      it('invalid disambiguation', () => {
        ;['', 'EARLIER', 'balance', 3, null].forEach((disambiguation) => {
          return throws(() => {
            return zdt.with({ day: 5 }, { disambiguation })
          }, RangeError)
        })
      })
    })
    describe('Offset option', () => {
      ...
      it('use, with bogus offset, changes to the exact time with the offset', () => {
        ...
        equal(
          preserveExact.epochNanoseconds,
          Temporal.Instant.from('2019-03-10T02:30:01+23:59').epochNanoseconds
        )
      })
      ...
      it('reject, with bogus offset, throws', () => {
        throws(() => {
          return dstStartDay.with(
            { ...twoThirty, offset: '+23:59' },
            { offset: 'reject' }
          )
        }, RangeError)
      })
      const doubleTime = ZonedDateTime.from(
        '2019-11-03T01:30:01-03:30[America/St_Johns]'
      )
      it('use changes to the exact time with the offset', () => {
        const preserveExact = doubleTime.with(
          { offset: '-02:30' },
          { offset: 'use' }
        )
        ...
        equal(
          preserveExact.epochNanoseconds,
          Temporal.Instant.from('2019-11-03T01:30:01-02:30').epochNanoseconds
        )
      })
      ...
      it('prefer is the default', () => {
        ...
        equal(
          `${dstEndDay.with(twoThirty)}`,
          `${dstEndDay.with(twoThirty, { offset: 'prefer' })}`
        )
        equal(
          `${doubleTime.with({ minute: 31 })}`,
          `${doubleTime.with({ minute: 31 }, { offset: 'prefer' })}`
        )
      })
      it('invalid offset', () => {
        ;['', 'PREFER', 'balance', 3, null].forEach((offset) => {
          return throws(() => {
            return zdt.with({ day: 5 }, { offset })
          }, RangeError)
        })
      })
    })
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return zdt.with({ day: 5 }, badOptions)
        }, TypeError)
      })
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(
          `${zdt.with({ day: 5 }, options)}`,
          '1976-11-05T15:23:30.123456789+00:00[UTC]'
        )
      })
    })
    it('object must contain at least one correctly-spelled property', () => {
      ...
      throws(() => {
        return zdt.with({ months: 12 })
      }, TypeError)
    })
    it('incorrectly-spelled properties are ignored', () => {
      equal(
        `${zdt.with({ month: 12, days: 15 })}`,
        '1976-12-18T15:23:30.123456789+00:00[UTC]'
      )
    })
    it('throws if timeZone is included', () => {
      throws(() => {
        return zdt.with({ month: 2, timeZone: 'Asia/Ulaanbaatar' })
      }, TypeError)
    })
    it('throws if given a Temporal object with a time zone', () => {
      throws(() => {
        return zdt.with(dstStartDay)
      }, TypeError)
    })
    it('throws if calendarName is included', () => {
      throws(() => {
        return zdt.with({ month: 2, calendar: 'japanese' })
      }, TypeError)
    })
    it('throws if given a Temporal object with a calendar', () => {
      throws(() => {
        return zdt.with(Temporal.PlainDateTime.from('1976-11-18T12:00'))
      }, TypeError)
      throws(() => {
        return zdt.with(Temporal.PlainDate.from('1976-11-18'))
      }, TypeError)
      throws(() => {
        return zdt.with(Temporal.PlainTime.from('12:00'))
      }, TypeError)
      throws(() => {
        return zdt.with(Temporal.PlainYearMonth.from('1976-11'))
      }, TypeError)
      throws(() => {
        return zdt.with(Temporal.PlainMonthDay.from('11-18'))
      }, TypeError)
    })
    it('throws if given a string', () => {
      throws(() => {
        return zdt.with('1976-11-18T12:00+00:00[UTC]')
      }, TypeError)
      throws(() => {
        return zdt.with('1976-11-18')
      }, TypeError)
      throws(() => {
        return zdt.with('12:00')
      }, TypeError)
      throws(() => {
        return zdt.with('invalid')
      }, TypeError)
    })
  })
  ...
  describe('.withPlainTime manipulation', () => {
    const zdt = Temporal.ZonedDateTime.from(
      '2015-12-07T03:24:30.000003500[America/Los_Angeles]'
    )
    ...
    it('withPlainTime(time) works', () => {
      ...
      equal(
        ...
        '2015-12-07T11:22:00-08:00[America/Los_Angeles]'
      )
    })
    it("withPlainTime('12:34') works", () => {
      equal(
        `${zdt.withPlainTime('12:34')}`,
        '2015-12-07T12:34:00-08:00[America/Los_Angeles]'
      )
    })
    it('withPlainTime() defaults to midnight', () => {
      equal(
        `${zdt.withPlainTime()}`,
        '2015-12-07T00:00:00-08:00[America/Los_Angeles]'
      )
    })
    it('object must contain at least one correctly-spelled property', () => {
      throws(() => {
        return zdt.withPlainTime({})
      }, TypeError)
      throws(() => {
        return zdt.withPlainTime({ minutes: 12 })
      }, TypeError)
    })
    it('incorrectly-spelled properties are ignored', () => {
      equal(
        `${zdt.withPlainTime({ hour: 10, seconds: 55 })}`,
        '2015-12-07T10:00:00-08:00[America/Los_Angeles]'
      )
    })
  })
    ...
    it('throws if both `this` and `other` have a non-ISO calendar', () => {
      throws(() => {
        return zdt
          ...
          .withPlainDate('2008-09-06-07:00[America/Los_Angeles][u-ca=japanese]')
      }, RangeError)
    })
    it('object must contain at least one correctly-spelled property', () => {
      throws(() => {
        return zdt.withPlainDate({})
      }, TypeError)
      throws(() => {
        return zdt.withPlainDate({ months: 12 })
      }, TypeError)
    })
    it('incorrectly-spelled properties are ignored', () => {
      equal(
  ...
  describe('ZonedDateTime.withTimeZone()', () => {
    ...
    it('keeps instant and calendar the same', () => {
      const zdt = ZonedDateTime.from(
        '2019-11-18T15:23:30.123456789+01:00[Europe/Madrid][u-ca=gregory]'
      )
  ...
  describe('Reversibility of differences', () => {
    const earlier = ZonedDateTime.from(
      '1976-11-18T15:23:30.123456789-03:00[America/Santiago]'
    )
    const later = ZonedDateTime.from(
      '2019-10-29T10:46:38.271986102-03:00[America/Santiago]'
    )
    ...
    ;['hours', 'minutes', 'seconds'].forEach((largestUnit) => {
      ...
      it(`earlier.until(later, ${largestUnit}) == later.since(earlier, ${largestUnit})`, () => {
        return equal(`${earlier.until(later, { largestUnit })}`, `${diff}`)
      })
    ...
    ;[
      ...
      it(`earlier.add(${diff1}) == later`, () => {
        return assert(earlier.add(diff1).equals(later))
      })
      it(`later.subtract(${diff2}) == earlier`, () => {
        return assert(later.subtract(diff2).equals(earlier))
      })
    })
  })
  describe('date/time maths: hours overflow', () => {
    ...
    it('add result', () => {
      const earlier = ZonedDateTime.from(
        '2020-05-31T23:12:38.271986102-04:00[America/Santiago]'
      )
  ...
  describe('ZonedDateTime.add()', () => {
    ...
    describe('cross epoch in ms', () => {
      ...
      it(`(${zdt}).subtract({ hours: 240, nanoseconds: 800 }) = ${one}`, () => {
        return equal(`${one}`, '1969-12-15T12:23:45.678900434+00:00[UTC]')
      })
      it(`(${zdt}).add({ hours: 240, nanoseconds: 800 }) = ${two}`, () => {
        return equal(`${two}`, '1970-01-04T12:23:45.678902034+00:00[UTC]')
      })
      it(`(${two}).subtract({ hours: 480, nanoseconds: 1600 }) = ${one}`, () => {
        return assert(three.equals(one))
      })
      it(`(${one}).add({ hours: 480, nanoseconds: 1600 }) = ${two}`, () => {
        return assert(four.equals(two))
      })
    })
    ...
    it('casts argument', () => {
      equal(
        `${zdt.add('PT240H0.000000800S')}`,
        '1970-01-04T12:23:45.678902034+00:00[UTC]'
      )
    })
    const jan31 = ZonedDateTime.from(
      '2020-01-31T15:00-08:00[America/Vancouver]'
    )
    ...
    it('symmetrical with regard to negative durations in the time part', () => {
      equal(
        ...
        '2020-01-31T14:30:00-08:00[America/Vancouver]'
      )
      equal(
        `${jan31.add({ seconds: -30 })}`,
        '2020-01-31T14:59:30-08:00[America/Vancouver]'
      )
    })
    it('throw when ambiguous result with reject', () => {
      throws(() => {
        return jan31.add({ months: 1 }, { overflow: 'reject' })
      }, RangeError)
    })
    it('invalid overflow', () => {
      ;['', 'CONSTRAIN', 'balance', 3, null].forEach((overflow) => {
        return throws(() => {
          return zdt.add({ months: 1 }, { overflow })
        }, RangeError)
      })
    })
    it('mixed positive and negative values always throw', () => {
      ;['constrain', 'reject'].forEach((overflow) => {
        return throws(() => {
          return zdt.add({ hours: 1, minutes: -30 }, { overflow })
        }, RangeError)
      })
    })
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return zdt.add({ years: 1 }, badOptions)
        }, TypeError)
      })
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(
          `${zdt.add({ years: 1 }, options)}`,
          '1970-12-25T12:23:45.678901234+00:00[UTC]'
        )
      })
    })
    it('object must contain at least one correctly-spelled property', () => {
      ...
      throws(() => {
        return zdt.add({ hour: 12 })
      }, TypeError)
    })
    it('incorrectly-spelled properties are ignored', () => {
      equal(
        `${zdt.add({ hour: 1, minutes: 1 })}`,
        '1969-12-25T12:24:45.678901234+00:00[UTC]'
      )
    })
  })
  describe('ZonedDateTime.subtract()', () => {
    ...
    const mar31 = ZonedDateTime.from(
      '2020-03-31T15:00-07:00[America/Vancouver]'
    )
    it('constrain when ambiguous result', () => {
      equal(
    ...
    it('symmetrical with regard to negative durations in the time part', () => {
      equal(
        ...
        '2020-03-31T15:30:00-07:00[America/Vancouver]'
      )
      equal(
        `${mar31.subtract({ seconds: -30 })}`,
        '2020-03-31T15:00:30-07:00[America/Vancouver]'
      )
    })
    it('throw when ambiguous result with reject', () => {
      throws(() => {
        return mar31.subtract({ months: 1 }, { overflow: 'reject' })
      }, RangeError)
    })
    it('invalid overflow', () => {
      ;['', 'CONSTRAIN', 'balance', 3, null].forEach((overflow) => {
        return throws(() => {
          return zdt.subtract({ months: 1 }, { overflow })
        }, RangeError)
      })
    })
    it('mixed positive and negative values always throw', () => {
    ...
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return zdt.subtract({ years: 1 }, badOptions)
        }, TypeError)
      })
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(
          `${zdt.subtract({ years: 1 }, options)}`,
          '1968-12-25T12:23:45.678901234+00:00[UTC]'
        )
      })
    })
    it('object must contain at least one correctly-spelled property', () => {
      ...
      throws(() => {
        return zdt.subtract({ hour: 12 })
      }, TypeError)
    })
    it('incorrectly-spelled properties are ignored', () => {
      equal(
        `${zdt.subtract({ hour: 1, minutes: 1 })}`,
        '1969-12-25T12:22:45.678901234+00:00[UTC]'
      )
    })
  })
  ...
  describe('ZonedDateTime.until()', () => {
    ...
    it('casts argument', () => {
      ...
      equal(
        `${zdt.until('2019-10-29T10:46:38.271986102+01:00[Europe/Vienna]')}`,
    ...
    it('defaults to returning hours', () => {
      ...
      equal(
        `${feb20.until(
          ZonedDateTime.from(
            '2021-02-01T00:00:00.000000001+01:00[Europe/Vienna]'
          )
        )}`,
        'PT8784H0.000000001S'
      )
      equal(
        `${ZonedDateTime.from(
          '2020-02-01T00:00:00.000000001+01:00[Europe/Vienna]'
        ).until(feb21)}`,
    ...
    it('does not include higher units than necessary', () => {
      const lastFeb20 = ZonedDateTime.from(
        '2020-02-29T00:00+01:00[Europe/Vienna]'
      )
      const lastJan21 = ZonedDateTime.from(
        '2021-01-31T00:00+01:00[Europe/Vienna]'
      )
      equal(`${lastFeb20.until(lastJan21)}`, 'PT8088H')
      equal(
        `${lastFeb20.until(lastJan21, { largestUnit: 'months' })}`,
        'P11M2D'
      )
    ...
    it('no two different calendars', () => {
      ...
      const zdt2 = new ZonedDateTime(
        0n,
        'UTC',
        Temporal.Calendar.from('japanese')
      )
      throws(() => {
        return zdt1.until(zdt2)
      }, RangeError)
    })
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return feb20.until(feb21, badOptions)
        }, TypeError)
      })
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(`${feb20.until(feb21, options)}`, 'PT8784H')
      })
    })
    const earlier = ZonedDateTime.from(
      '2019-01-08T09:22:36.123456789+01:00[Europe/Vienna]'
    )
    const later = ZonedDateTime.from(
      '2021-09-07T14:39:40.987654321+02:00[Europe/Vienna]'
    )
    it('throws on disallowed or invalid smallestUnit', () => {
      ;['era', 'nonsense'].forEach((smallestUnit) => {
        throws(() => {
          return earlier.until(later, { smallestUnit })
        }, RangeError)
      })
    })
    it('throws if smallestUnit is larger than largestUnit', () => {
      ...
      for (let largestIdx = 1; largestIdx < units.length; largestIdx++) {
        for (let smallestIdx = 0; smallestIdx < largestIdx; smallestIdx++) {
          ...
          throws(() => {
            return earlier.until(later, { largestUnit, smallestUnit })
          }, RangeError)
        }
      }
    })
    ...
    it('throws on invalid roundingMode', () => {
      throws(() => {
        return earlier.until(later, { roundingMode: 'cile' })
      }, RangeError)
    })
    ...
    it('accepts singular units', () => {
      ...
      equal(
        `${earlier.until(later, { largestUnit: 'day' })}`,
        `${earlier.until(later, { largestUnit: 'days' })}`
      )
      equal(
        `${earlier.until(later, { smallestUnit: 'day' })}`,
        `${earlier.until(later, { smallestUnit: 'days' })}`
      )
      equal(
  ...
  describe('ZonedDateTime.since()', () => {
    ...
    it('casts argument', () => {
      ...
      equal(
        `${zdt.since('2019-10-29T10:46:38.271986102+01:00[Europe/Vienna]')}`,
        '-PT376435H23M8.148529313S'
      )
    })
    const feb20 = ZonedDateTime.from('2020-02-01T00:00+01:00[Europe/Vienna]')
    ...
    it('does not include higher units than necessary', () => {
      ...
      const lastFeb21 = ZonedDateTime.from(
        '2021-02-28T00:00+01:00[Europe/Vienna]'
      )
      equal(`${lastFeb21.since(lastFeb20)}`, 'PT8760H')
      equal(
        `${lastFeb21.since(lastFeb20, { largestUnit: 'months' })}`,
        'P11M28D'
      )
      equal(
        `${lastFeb21.since(lastFeb20, { largestUnit: 'years' })}`,
        'P11M28D'
      )
    })
    it('weeks and months are mutually exclusive', () => {
    ...
    it('no two different calendars', () => {
      ...
      throws(() => {
        return zdt1.since(zdt2)
      }, RangeError)
    })
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return feb21.since(feb20, badOptions)
        }, TypeError)
      })
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(`${feb21.since(feb20, options)}`, 'PT8784H')
      })
    })
    const earlier = ZonedDateTime.from(
      '2019-01-08T09:22:36.123456789+01:00[Europe/Vienna]'
    ...
    it('throws on disallowed or invalid smallestUnit', () => {
      ;['era', 'nonsense'].forEach((smallestUnit) => {
        throws(() => {
          return later.since(earlier, { smallestUnit })
        }, RangeError)
      })
    })
    it('throws if smallestUnit is larger than largestUnit', () => {
      ...
      for (let largestIdx = 1; largestIdx < units.length; largestIdx++) {
        for (let smallestIdx = 0; smallestIdx < largestIdx; smallestIdx++) {
          ...
          const smallestUnit = units[smallestIdx]
          throws(() => {
            return later.since(earlier, { largestUnit, smallestUnit })
          }, RangeError)
        }
      }
    })
    ...
    it('throws on invalid roundingMode', () => {
      throws(() => {
        return later.since(earlier, { roundingMode: 'cile' })
      }, RangeError)
    })
    const incrementOneNearest = [
      ['years', 'P3Y'],
    ...
    it('accepts singular units', () => {
      equal(
        `${later.since(earlier, { largestUnit: 'year' })}`,
        `${later.since(earlier, { largestUnit: 'years' })}`
      )
      equal(
        `${later.since(earlier, { smallestUnit: 'year' })}`,
        `${later.since(earlier, { smallestUnit: 'years' })}`
      )
      equal(
        `${later.since(earlier, { largestUnit: 'month' })}`,
      ...
      equal(
        `${later.since(earlier, { largestUnit: 'day' })}`,
        `${later.since(earlier, { largestUnit: 'days' })}`
      )
      equal(
        `${later.since(earlier, { smallestUnit: 'day' })}`,
        `${later.since(earlier, { smallestUnit: 'days' })}`
      )
      equal(
        `${later.since(earlier, { largestUnit: 'hour' })}`,
        `${later.since(earlier, { largestUnit: 'hours' })}`
      )
      equal(
        `${later.since(earlier, { smallestUnit: 'hour' })}`,
  ...
  describe('ZonedDateTime.round()', () => {
    ...
    it('throws without required smallestUnit parameter', () => {
      ...
      throws(() => {
        return zdt.round({ roundingIncrement: 1, roundingMode: 'ceil' })
      }, RangeError)
    })
    it('throws on disallowed or invalid smallestUnit', () => {
      ;[
        ...
        throws(() => {
          return zdt.round({ smallestUnit })
        }, RangeError)
      })
    })
    it('throws on invalid roundingMode', () => {
      throws(() => {
        return zdt.round({ smallestUnit: 'second', roundingMode: 'cile' })
      }, RangeError)
    })
    const incrementOneNearest = [
    ...
    incrementOneNearest.forEach(([smallestUnit, expected]) => {
      it(`rounds to nearest ${smallestUnit}`, () => {
        return equal(
          `${zdt.round({ smallestUnit, roundingMode: 'halfExpand' })}`,
          expected
        )
      })
    })
    ...
    incrementOneCeil.forEach(([smallestUnit, expected]) => {
      it(`rounds up to ${smallestUnit}`, () => {
        return equal(
          `${zdt.round({ smallestUnit, roundingMode: 'ceil' })}`,
          expected
        )
      })
    })
    ...
    incrementOneFloor.forEach(([smallestUnit, expected]) => {
      it(`rounds down to ${smallestUnit}`, () => {
        return equal(
          `${zdt.round({ smallestUnit, roundingMode: 'floor' })}`,
          expected
        )
      })
      it(`truncates to ${smallestUnit}`, () => {
        return equal(
          `${zdt.round({ smallestUnit, roundingMode: 'trunc' })}`,
          expected
        )
      })
    })
    it('halfExpand is the default', () => {
      equal(
        `${zdt.round({ smallestUnit: 'minute' })}`,
        '1976-11-18T15:24:00+01:00[Europe/Vienna]'
      )
      equal(
        `${zdt.round({ smallestUnit: 'second' })}`,
    ...
    it('rounding down is towards the Big Bang, not towards the epoch', () => {
      ...
      equal(
        `${zdt2.round({ smallestUnit, roundingMode: 'ceil' })}`,
        '1969-12-15T12:00:01+00:00[UTC]'
      )
      equal(
        `${zdt2.round({ smallestUnit, roundingMode: 'floor' })}`,
        '1969-12-15T12:00:00+00:00[UTC]'
      )
      equal(
        `${zdt2.round({ smallestUnit, roundingMode: 'trunc' })}`,
        '1969-12-15T12:00:00+00:00[UTC]'
      )
      equal(
        `${zdt2.round({ smallestUnit, roundingMode: 'halfExpand' })}`,
        '1969-12-15T12:00:01+00:00[UTC]'
      )
    })
    it('rounding down is towards the Big Bang, not towards 1 BCE', () => {
      ...
      const smallestUnit = 'second'
      equal(
        `${zdt3.round({ smallestUnit, roundingMode: 'ceil' })}`,
        '-000099-12-15T12:00:01+00:00[UTC]'
      )
      equal(
        `${zdt3.round({ smallestUnit, roundingMode: 'floor' })}`,
        '-000099-12-15T12:00:00+00:00[UTC]'
      )
      equal(
        `${zdt3.round({ smallestUnit, roundingMode: 'trunc' })}`,
        '-000099-12-15T12:00:00+00:00[UTC]'
      )
      equal(
        `${zdt3.round({ smallestUnit, roundingMode: 'halfExpand' })}`,
        '-000099-12-15T12:00:01+00:00[UTC]'
      )
    })
    it('rounds to an increment of hours', () => {
    ...
    it('1 day is a valid increment', () => {
      equal(
        `${zdt.round({ smallestUnit: 'day', roundingIncrement: 1 })}`,
    ...
    it('valid hour increments divide into 24', () => {
      ...
      ;[1, 2, 3, 4, 6, 8, 12].forEach((roundingIncrement) => {
        assert(
          zdt.round({ smallestUnit, roundingIncrement }) instanceof
            ZonedDateTime
        )
      })
    })
    ...
    it('throws on increments that do not divide evenly into the next highest', () => {
      throws(() => {
        return zdt.round({ smallestUnit: 'day', roundingIncrement: 29 })
      }, RangeError)
      throws(() => {
        return zdt.round({ smallestUnit: 'hour', roundingIncrement: 29 })
      }, RangeError)
      throws(() => {
        return zdt.round({ smallestUnit: 'minute', roundingIncrement: 29 })
      }, RangeError)
      throws(() => {
        return zdt.round({ smallestUnit: 'second', roundingIncrement: 29 })
      }, RangeError)
      throws(() => {
        return zdt.round({ smallestUnit: 'millisecond', roundingIncrement: 29 })
      }, RangeError)
      throws(() => {
        return zdt.round({ smallestUnit: 'microsecond', roundingIncrement: 29 })
      }, RangeError)
      throws(() => {
        return zdt.round({ smallestUnit: 'nanosecond', roundingIncrement: 29 })
      }, RangeError)
    })
    it('throws on increments that are equal to the next highest', () => {
      throws(() => {
        return zdt.round({ smallestUnit: 'hour', roundingIncrement: 24 })
      }, RangeError)
      throws(() => {
        return zdt.round({ smallestUnit: 'minute', roundingIncrement: 60 })
      }, RangeError)
      throws(() => {
        return zdt.round({ smallestUnit: 'second', roundingIncrement: 60 })
      }, RangeError)
      throws(() => {
        return zdt.round({
    ...
    const bal = ZonedDateTime.from(
      '1976-11-18T23:59:59.999999999+01:00[Europe/Vienna]'
    )
    ;['day', 'hour', 'minute', 'second', 'millisecond', 'microsecond'].forEach(
      (smallestUnit) => {
        it(`balances to next ${smallestUnit}`, () => {
          equal(
            `${bal.round({ smallestUnit })}`,
            '1976-11-19T00:00:00+01:00[Europe/Vienna]'
          )
        })
      }
    ...
    it('accepts plural units', () => {
      assert(
        zdt
          .round({ smallestUnit: 'hours' })
          .equals(zdt.round({ smallestUnit: 'hour' }))
      )
      assert(
        zdt
          .round({ smallestUnit: 'minutes' })
          .equals(zdt.round({ smallestUnit: 'minute' }))
      )
      assert(
        zdt
          .round({ smallestUnit: 'seconds' })
          .equals(zdt.round({ smallestUnit: 'second' }))
      )
      assert(
        zdt
          .round({ smallestUnit: 'milliseconds' })
          .equals(zdt.round({ smallestUnit: 'millisecond' }))
      )
      assert(
        zdt
          .round({ smallestUnit: 'microseconds' })
          .equals(zdt.round({ smallestUnit: 'microsecond' }))
      )
      assert(
        zdt
          .round({ smallestUnit: 'nanoseconds' })
          .equals(zdt.round({ smallestUnit: 'nanosecond' }))
      )
    })
    it('rounds correctly to a 25-hour day', () => {
      const options = { smallestUnit: 'day' }
      const roundMeDown = ZonedDateTime.from(
        '2020-11-01T12:29:59-08:00[America/Vancouver]'
      )
      equal(
        `${roundMeDown.round(options)}`,
        '2020-11-01T00:00:00-07:00[America/Vancouver]'
      )
      const roundMeUp = ZonedDateTime.from(
        '2020-11-01T12:30:01-08:00[America/Vancouver]'
      )
      equal(
        `${roundMeUp.round(options)}`,
    ...
    it('rounds correctly to a 23-hour day', () => {
      const options = { smallestUnit: 'day' }
      const roundMeDown = ZonedDateTime.from(
        '2020-03-08T11:29:59-07:00[America/Vancouver]'
      )
      equal(
        `${roundMeDown.round(options)}`,
      ...
      const roundMeUp = ZonedDateTime.from(
        '2020-03-08T11:30:01-07:00[America/Vancouver]'
      )
      equal(
        `${roundMeUp.round(options)}`,
    ...
    it('rounding up to a nonexistent wall-clock time', () => {
      const almostSkipped = ZonedDateTime.from(
        '2018-11-03T23:59:59.999999999-03:00[America/Sao_Paulo]'
      )
      const rounded = almostSkipped.round({
        smallestUnit: 'microsecond',
        roundingMode: 'halfExpand',
      })
  ...
  describe('ZonedDateTime.equals()', () => {
    ...
    it('casts its argument', () => {
      assert(
        zdt.equals('1969-12-31T19:00-05:00[America/New_York][u-ca=gregory]')
      )
      assert(
        zdt.equals({
          year: 1969,
    ...
    it('at least the required properties must be present', () => {
      ...
      throws(() => {
        return zdt.equals({ month: 12, day: 31, timeZone: 'America/New_York' })
      }, TypeError)
      throws(() => {
        return zdt.equals({ year: 1969, day: 31, timeZone: 'America/New_York' })
      }, TypeError)
      throws(() => {
        return zdt.equals({
          year: 1969,
      ...
      throws(() => {
        return zdt.equals({ year: 1969, month: 12, day: 31 })
      }, TypeError)
      throws(() => {
        return zdt.equals({
          years: 1969,
  ...
  describe('ZonedDateTime.toString()', () => {
    ...
    const zdt3 = ZonedDateTime.from(
      '1976-11-18T15:23:30.1234+01:00[Europe/Vienna]'
    )
    ...
    it('shows only non-ISO calendar if calendarName = auto', () => {
      equal(
        zdt1.toString({ calendarName: 'auto' }),
    ...
    it('shows ISO calendar if calendarName = always', () => {
      equal(
        zdt1.toString({ calendarName: 'always' }),
        '1976-11-18T15:23:00+01:00[Europe/Vienna][u-ca=iso8601]'
      )
    })
    ...
    it('default is calendar = auto', () => {
      equal(zdt1.toString(), '1976-11-18T15:23:00+01:00[Europe/Vienna]')
      equal(
        zdt1.withCalendar('gregory').toString(),
        '1976-11-18T15:23:00+01:00[Europe/Vienna][u-ca=gregory]'
      )
    })
    ...
    it('combinations of calendar, time zone, and offset', () => {
      ...
      equal(
        zdt.toString({ timeZoneName: 'never', calendarName: 'never' }),
        '1976-11-18T15:23:00+01:00'
      )
      equal(
        zdt.toString({ offset: 'never', calendarName: 'never' }),
        '1976-11-18T15:23:00[Europe/Vienna]'
      )
      equal(
    ...
    it('other smallestUnits are aliases for fractional digits', () => {
      equal(
        zdt3.toString({ smallestUnit: 'second' }),
        zdt3.toString({ fractionalSecondDigits: 0 })
      )
      equal(
        zdt3.toString({ smallestUnit: 'millisecond' }),
        zdt3.toString({ fractionalSecondDigits: 3 })
      )
      equal(
        zdt3.toString({ smallestUnit: 'microsecond' }),
        zdt3.toString({ fractionalSecondDigits: 6 })
      )
      equal(
        zdt3.toString({ smallestUnit: 'nanosecond' }),
        zdt3.toString({ fractionalSecondDigits: 9 })
      )
    })
    it('throws on invalid or disallowed smallestUnit', () => {
      ;['era', 'year', 'month', 'day', 'hour', 'nonsense'].forEach(
        (smallestUnit) => {
          return throws(() => {
            return zdt1.toString({ smallestUnit })
          }, RangeError)
        }
      )
    })
    it('accepts plural units', () => {
      equal(
        zdt3.toString({ smallestUnit: 'minutes' }),
        zdt3.toString({ smallestUnit: 'minute' })
      )
      equal(
        zdt3.toString({ smallestUnit: 'seconds' }),
        zdt3.toString({ smallestUnit: 'second' })
      )
      equal(
        zdt3.toString({ smallestUnit: 'milliseconds' }),
        zdt3.toString({ smallestUnit: 'millisecond' })
      )
      equal(
        zdt3.toString({ smallestUnit: 'microseconds' }),
        zdt3.toString({ smallestUnit: 'microsecond' })
      )
      equal(
        zdt3.toString({ smallestUnit: 'nanoseconds' }),
        zdt3.toString({ smallestUnit: 'nanosecond' })
      )
    })
    it('truncates or pads to 2 places', () => {
      ...
      equal(
        zdt1.toString(options),
        '1976-11-18T15:23:00.00+01:00[Europe/Vienna]'
      )
      equal(
        zdt2.toString(options),
        '1976-11-18T15:23:30.00+01:00[Europe/Vienna]'
      )
      equal(
        zdt3.toString(options),
        '1976-11-18T15:23:30.12+01:00[Europe/Vienna]'
      )
    })
    it('pads to 7 places', () => {
      ...
      equal(
        zdt1.toString(options),
        '1976-11-18T15:23:00.0000000+01:00[Europe/Vienna]'
      )
      equal(
        zdt2.toString(options),
        '1976-11-18T15:23:30.0000000+01:00[Europe/Vienna]'
      )
      equal(
        zdt3.toString(options),
        '1976-11-18T15:23:30.1234000+01:00[Europe/Vienna]'
      )
    })
    it('auto is the default', () => {
      ;[zdt1, zdt2, zdt3].forEach((zdt) => {
        return equal(
          zdt.toString({ fractionalSecondDigits: 'auto' }),
          zdt.toString()
        )
      })
    })
    it('throws on out of range or invalid fractionalSecondDigits', () => {
      ;[-1, 10, Infinity, NaN, 'not-auto'].forEach((fractionalSecondDigits) => {
        return throws(() => {
          return zdt1.toString({ fractionalSecondDigits })
        }, RangeError)
      })
    })
    it('accepts and truncates fractional fractionalSecondDigits', () => {
      equal(
        zdt3.toString({ fractionalSecondDigits: 5.5 }),
        '1976-11-18T15:23:30.12340+01:00[Europe/Vienna]'
      )
    })
    ...
    it('throws on invalid roundingMode', () => {
      throws(() => {
        return zdt1.toString({ roundingMode: 'cile' })
      }, RangeError)
    })
    ...
    it('rounds up', () => {
      equal(
        zdt2.toString({ smallestUnit: 'minute', roundingMode: 'ceil' }),
        '1976-11-18T15:24+01:00[Europe/Vienna]'
      )
      equal(
    ...
    it('rounds down', () => {
      ;['floor', 'trunc'].forEach((roundingMode) => {
        equal(
          zdt2.toString({ smallestUnit: 'minute', roundingMode }),
          '1976-11-18T15:23+01:00[Europe/Vienna]'
        )
        equal(
    ...
    it('rounding down is towards the Big Bang, not towards 1 BCE', () => {
      ...
      equal(
        zdt4.toString({ smallestUnit: 'second', roundingMode: 'floor' }),
        '-000099-12-15T12:00:00+00:00[UTC]'
      )
    })
    it('rounding can affect all units', () => {
      const zdt5 = ZonedDateTime.from(
        '1999-12-31T23:59:59.999999999+01:00[Europe/Berlin]'
      )
      equal(
        zdt5.toString({
    ...
    it('rounding up to a nonexistent wall-clock time', () => {
      ...
      const roundedString = zdt5.toString({
        fractionalSecondDigits: 8,
        roundingMode: 'halfExpand',
      })
      equal(
        roundedString,
        '2018-11-04T01:00:00.00000000-02:00[America/Sao_Paulo]'
      )
    ...
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return zdt1.toString(badOptions)
        }, TypeError)
      })
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(
  ...
  describe("Comparison operators don't work", () => {
    const zdt1 = ZonedDateTime.from(
      '1963-02-13T09:36:29.123456789+01:00[Europe/Vienna]'
    )
    const zdt1again = ZonedDateTime.from(
      '1963-02-13T09:36:29.123456789+01:00[Europe/Vienna]'
    )
    const zdt2 = ZonedDateTime.from(
      '1976-11-18T15:23:30.123456789+01:00[Europe/Vienna]'
    ...
    it('=== is object equality', () => {
      return equal(zdt1, zdt1)
    })
    it('!== is object equality', () => {
      return notEqual(zdt1, zdt1again)
    })
    it('<', () => {
      return throws(() => {
        return zdt1 < zdt2
  ...
  describe('ZonedDateTime.toInstant()', () => {
    it('recent date', () => {
      const zdt = ZonedDateTime.from(
        '2019-10-29T10:46:38.271986102+01:00[Europe/Amsterdam]'
      )
      equal(`${zdt.toInstant()}`, '2019-10-29T09:46:38.271986102Z')
    })
    it('year ≤ 99', () => {
      const zdt = ZonedDateTime.from(
        '+000098-10-29T10:46:38.271986102+00:00[UTC]'
      )
      equal(`${zdt.toInstant()}`, '+000098-10-29T10:46:38.271986102Z')
    })
    it('year < 1', () => {
      let zdt = ZonedDateTime.from(
        '+000000-10-29T10:46:38.271986102+00:00[UTC]'
      )
    ...
    it('year 0 leap day', () => {
      const zdt = ZonedDateTime.from(
        '+000000-02-29T00:00-00:01:15[Europe/London]'
      )
  ...
  describe('ZonedDateTime.toPlainDate()', () => {
    it('works', () => {
      const zdt = Temporal.Instant.from(
        '2019-10-29T09:46:38.271986102Z'
  ...
  describe('ZonedDateTime.getISOFields()', () => {
    const zdt1 = ZonedDateTime.from(
      '1976-11-18T15:23:30.123456789+08:00[Asia/Shanghai]'
    )
  ...
  const hourBeforeDstStart = new Temporal.PlainDateTime(
    2020,
    3,
    8,
    1
  ).toZonedDateTime(tz)
  const dayBeforeDstStart = new Temporal.PlainDateTime(
    2020,
    3,
    7,
    2,
  ...
  describe('properties around DST', () => {
    ...
    it('hoursInDay works with DST end', () => {
      const dstEnd = ZonedDateTime.from(
    ...
    const dayAfterSamoaDateLineChange = ZonedDateTime.from(
      '2011-12-31T22:00+14:00[Pacific/Apia]'
    )
    const dayBeforeSamoaDateLineChange = ZonedDateTime.from(
      '2011-12-29T22:00-10:00[Pacific/Apia]'
    )
  ...
  describe('math around DST', () => {
    it('add 1 hour to get to DST start', () => {
      ...
      equal(
        `${diff}`,
        `${added.since(hourBeforeDstStart, { largestUnit: 'hours' })}`
      )
    ...
    it('Samoa date line change (add): 10:00PM 29 Dec 2011 -> 11:00PM 31 Dec 2011', () => {
      ...
      const dayBeforeSamoaDateLineChangeAbs = timeZone.getInstantFor(
        new Temporal.PlainDateTime(2011, 12, 29, 22)
      )
    ...
    it('Samoa date line change (subtract): 11:00PM 31 Dec 2011 -> 10:00PM 29 Dec 2011', () => {
      const timeZone = Temporal.TimeZone.from('Pacific/Apia')
      const dayAfterSamoaDateLineChangeAbs = timeZone.getInstantFor(
        new Temporal.PlainDateTime(2011, 12, 31, 23)
      )
    ...
    it('Difference can return day length > 24 hours', () => {
      const start = ZonedDateTime.from(
        '2020-10-30T01:45-07:00[America/Los_Angeles]'
      )
      const end = ZonedDateTime.from(
        '2020-11-02T01:15-08:00[America/Los_Angeles]'
      )
    ...
    it('Difference rounding (nearest day) is DST-aware', () => {
      const start = ZonedDateTime.from(
        '2020-03-10T02:30-07:00[America/Los_Angeles]'
      )
      const end = ZonedDateTime.from(
        '2020-03-07T14:15-08:00[America/Los_Angeles]'
      )
    ...
    it('Difference when date portion ends inside a DST-skipped period', () => {
      ...
      const end = ZonedDateTime.from(
        '2020-03-08T03:15-07:00[America/Los_Angeles]'
      )
      const diff = start.until(end, { largestUnit: 'days' })
      equal(`${diff}`, 'PT23H45M')
    })
    ...
    it('Rounding up to hours causes one more day of overflow (positive)', () => {
      ...
      const end = ZonedDateTime.from(
        '2020-01-03T23:59-08:00[America/Los_Angeles]'
      )
      const diff = start.until(end, {
        largestUnit: 'days',
        smallestUnit: 'hours',
      ...
      for (let i = 0; i < startHourRange * stepsPerHour; i++) {
        ...
        for (let j = 0; j < hoursUntilEnd * stepsPerHour; j++) {
          ...
          if (i >= stepsPerHour) {
            ...
            const expectedHours =
              diff60 < 24 ? diff60 : diff60 < 48 ? diff60 - 24 : diff60 - 48
            ...
            const expectedHours =
              diff60 < 23 ? diff60 : diff60 < 47 ? diff60 - 23 : diff60 - 47
            equal(diff.hours, expectedHours)
            equal(diff.days, expectedDays)
          }
        }
  ...
  describe('math order of operations and options', () => {
    const breakoutUnits = (op, zdt, d, options) => {
      return zdt[op]({ years: d.years }, options)
    ...
    it('order of operations: add / none', () => {
      const zdt = ZonedDateTime.from(
        '2020-01-31T00:00-08:00[America/Los_Angeles]'
      )
    ...
    it('order of operations: add / reject', () => {
      ...
      throws(() => {
        return zdt.add(d, options)
      }, RangeError)
    })
    it('order of operations: subtract / none', () => {
      const zdt = ZonedDateTime.from(
        '2020-03-31T00:00-07:00[America/Los_Angeles]'
      )
      const d = Temporal.Duration.from({ months: 1, days: 1 })
      const options = undefined
      ...
      equal(
        breakoutUnits('subtract', zdt, d, options).toString(),
        result.toString()
      )
    })
  ...
  describe('ZonedDateTime.compare()', () => {
    ...
    const zdt2 = ZonedDateTime.from(
      '2019-10-29T10:46:38.271986102+01:00[Europe/Vienna]'
    )
    it('equal', () => {
      return equal(ZonedDateTime.compare(zdt1, zdt1), 0)
    })
    it('smaller/larger', () => {
      return equal(ZonedDateTime.compare(zdt1, zdt2), -1)
    })
    it('larger/smaller', () => {
      return equal(ZonedDateTime.compare(zdt2, zdt1), 1)
    })
    ...
    it('object must contain at least the required properties', () => {
      equal(
        ZonedDateTime.compare(
          { year: 1976, month: 11, day: 18, timeZone: 'Europe/Vienna' },
          zdt2
        ),
        -1
      )
      throws(() => {
        return ZonedDateTime.compare(
          { month: 11, day: 18, timeZone: 'Europe/Vienna' },
          zdt2
        )
      }, TypeError)
      throws(() => {
        return ZonedDateTime.compare(
          { year: 1976, day: 18, timeZone: 'Europe/Vienna' },
          zdt2
        )
      }, TypeError)
      throws(() => {
        return ZonedDateTime.compare(
          { year: 1976, month: 11, timeZone: 'Europe/Vienna' },
          zdt2
        )
      }, TypeError)
      throws(() => {
        return ZonedDateTime.compare({ year: 1976, month: 11, day: 18 }, zdt2)
      }, TypeError)
      throws(() => {
        return ZonedDateTime.compare(
          {
      ...
      throws(() => {
        return ZonedDateTime.compare(zdt1, {
          month: 10,
          day: 29,
          timeZone: 'Europe/Vienna',
        })
      ...
      throws(() => {
        return ZonedDateTime.compare(zdt1, { year: 2019, month: 10, day: 29 })
      }, TypeError)
      throws(() => {
        return ZonedDateTime.compare(zdt1, {
          years: 2019,
    ...
    it('compares exact time, not clock time', () => {
      const clockBefore = ZonedDateTime.from(
        '1999-12-31T23:30-08:00[America/Vancouver]'
      )
      const clockAfter = ZonedDateTime.from(
        '2000-01-01T01:30-04:00[America/Halifax]'
      )
      equal(ZonedDateTime.compare(clockBefore, clockAfter), 1)
      equal(
        Temporal.PlainDateTime.compare(
          clockBefore.toPlainDateTime(),
          clockAfter.toPlainDateTime()
        ),
        -1
      )
    })
