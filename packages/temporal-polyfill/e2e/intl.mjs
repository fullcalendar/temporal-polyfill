...
describe('Intl', () => {
  ...
  function maybeGetWeekdayOnlyFormat() {
    ...
    if (
      [
        ...
        return prop in fmt.resolvedOptions()
      })
    ) {
  ...
  describe('instant.toLocaleString()', () => {
    ...
    it(`(${instant.toString()}).toLocaleString('en-US', { timeZone: 'America/New_York' })`, () => {
      return equal(
        `${instant.toLocaleString('en', { timeZone: 'America/New_York' })}`,
        '11/18/1976, 9:23:30 AM'
      )
    })
    it(`(${instant.toString()}).toLocaleString('de-AT', { timeZone: 'Europe/Vienna' })`, () => {
      return equal(
        `${instant.toLocaleString('de', { timeZone: 'Europe/Vienna' })}`,
        '18.11.1976, 15:23:30'
      )
    })
    ...
    if (fmt) {
      it('uses only the options in resolvedOptions', () => {
        return equal(fmt.format(instant), 'Thursday')
      })
    }
    it('outputs timeZoneName if requested', () => {
      const str = instant.toLocaleString('en', {
  ...
  describe('zoneddatetime.toLocaleString()', () => {
    ...
    it(`(${zdt}).toLocaleString('en-US')`, () => {
      return equal(zdt.toLocaleString('en'), '11/18/1976, 3:23:30 PM GMT+1')
    })
    it(`(${zdt}).toLocaleString('de-AT')`, () => {
      return equal(zdt.toLocaleString('de'), '18.11.1976, 15:23:30 MEZ')
    })
    const fmt = maybeGetWeekdayOnlyFormat()

    if (fmt) {
      it('uses only the options in resolvedOptions', () => {
        return equal(fmt.format(zdt), 'Thursday')
      })
    }
    ...
    it("works if the time zone given in options agrees with the object's time zone", () => {
      equal(
        zdt.toLocaleString('en', { timeZone: 'Europe/Vienna' }),
        '11/18/1976, 3:23:30 PM GMT+1'
      )
    })
    it("throws if the time zone given in options disagrees with the object's time zone", () => {
      throws(() => {
        return zdt.toLocaleString('en', { timeZone: 'America/New_York' })
      }, RangeError)
    })
    it("works when the object's calendar is the same as the locale's calendar", () => {
      ...
      assert(
        result === '1/1/45, 12:00:00 AM UTC' ||
          result === '1/1/45 S, 12:00:00 AM UTC'
      )
    })
    it("adopts the locale's calendar when the object's calendar is ISO", () => {
      ...
      const result = zdt.toLocaleString('en-US-u-ca-japanese')
      assert(
        result === '11/18/51, 3:23:30 PM UTC' ||
          result === '11/18/51 S, 3:23:30 PM UTC'
      )
    })
    it('throws when the calendars are different and not ISO', () => {
      const zdt = new Temporal.ZonedDateTime(0n, 'UTC', 'gregory')
      throws(() => {
        return zdt.toLocaleString('en-US-u-ca-japanese')
      })
    })
  })
  describe('datetime.toLocaleString()', () => {
    ...
    it(`(${datetime.toString()}).toLocaleString('en-US', { timeZone: 'America/New_York' })`, () => {
      return equal(
        `${datetime.toLocaleString('en', { timeZone: 'America/New_York' })}`,
        '11/18/1976, 3:23:30 PM'
      )
    })
    it(`(${datetime.toString()}).toLocaleString('de-AT', { timeZone: 'Europe/Vienna' })`, () => {
      return equal(
        `${datetime.toLocaleString('de', { timeZone: 'Europe/Vienna' })}`,
        '18.11.1976, 15:23:30'
      )
    })
    const fmt = maybeGetWeekdayOnlyFormat()
    ...
    if (fmt) {
      it('uses only the options in resolvedOptions', () => {
        return equal(fmt.format(datetime), 'Thursday')
      })
    }
    it('should ignore units not in the data type', () => {
      equal(
        datetime.toLocaleString('en', { timeZoneName: 'long' }),
        '11/18/1976, 3:23:30 PM'
      )
    })
    it('should use compatible disambiguation option', () => {
      ...
      equal(
        `${dstStart.toLocaleString('en', { timeZone: 'America/Los_Angeles' })}`,
        '3/8/2020, 3:30:00 AM'
      )
    })
    it("works when the object's calendar is the same as the locale's calendar", () => {
      ...
      assert(
        result === '11/18/51, 3:23:30 PM' || result === '11/18/51 S, 3:23:30 PM'
      )
    })
    it("adopts the locale's calendar when the object's calendar is ISO", () => {
    ...
    it('throws when the calendars are different and not ISO', () => {
      ...
      throws(() => {
        return dt.toLocaleString('en-US-u-ca-japanese')
      })
    })
  })
  describe('time.toLocaleString()', () => {
    ...
    it(`(${time.toString()}).toLocaleString('en-US', { timeZone: 'America/New_York' })`, () => {
      return equal(
        `${time.toLocaleString('en', { timeZone: 'America/New_York' })}`,
        '3:23:30 PM'
      )
    })
    it(`(${time.toString()}).toLocaleString('de-AT', { timeZone: 'Europe/Vienna' })`, () => {
      return equal(
        `${time.toLocaleString('de', { timeZone: 'Europe/Vienna' })}`,
        '15:23:30'
      )
    })
    it('should ignore units not in the data type', () => {
  ...
  describe('date.toLocaleString()', () => {
    ...
    it(`(${date.toString()}).toLocaleString('en-US', { timeZone: 'America/New_York' })`, () => {
      return equal(
        `${date.toLocaleString('en', { timeZone: 'America/New_York' })}`,
        '11/18/1976'
      )
    })
    it(`(${date.toString()}).toLocaleString('de-AT', { timeZone: 'Europe/Vienna' })`, () => {
      return equal(
        `${date.toLocaleString('de', { timeZone: 'Europe/Vienna' })}`,
        '18.11.1976'
      )
    })
    const fmt = maybeGetWeekdayOnlyFormat()
    ...
    if (fmt) {
      it('uses only the options in resolvedOptions', () => {
        return equal(fmt.format(date), 'Thursday')
      })
    }
    it('should ignore units not in the data type', () => {
    ...
    it('throws when the calendars are different and not ISO', () => {
      ...
      throws(() => {
        return d.toLocaleString('en-US-u-ca-japanese')
      })
    })
  })
  describe('yearmonth.toLocaleString()', () => {
    ...
    it(`(${yearmonth.toString()}).toLocaleString('en-US', { timeZone: 'America/New_York' })`, () => {
      return equal(
        `${yearmonth.toLocaleString('en', { timeZone: 'America/New_York' })}`,
        '11/1976'
      )
    })
    ...
    it('throws when the calendar is not equal to the locale calendar', () => {
      ...
      throws(() => {
        return ymISO.toLocaleString('en-US-u-ca-japanese')
      }, RangeError)
    })
  })
  describe('monthday.toLocaleString()', () => {
    ...
    it(`(${monthday.toString()}).toLocaleString('en-US', { timeZone: 'America/New_York' })`, () => {
      return equal(
        `${monthday.toLocaleString('en', { timeZone: 'America/New_York' })}`,
        '11/18'
      )
    })
    it(`(${monthday.toString()}).toLocaleString('de-AT', { timeZone: 'Europe/Vienna' })`, () => {
      return equal(
        `${monthday.toLocaleString('de', {
          timeZone: 'Europe/Vienna',
          calendar,
        })}`,
        '18.11.'
    ...
    it('throws when the calendar is not equal to the locale calendar', () => {
      ...
      throws(() => {
        return mdISO.toLocaleString('en-US-u-ca-japanese')
      }, RangeError)
    })
  })

  describe('Non-ISO Calendars', () => {
    const testChineseData = new Date('2001-02-01T00:00Z').toLocaleString(
      'en-US-u-ca-chinese',
      {
        day: 'numeric',
        month: 'numeric',
    ...
    const itOrSkip = (id) => {
      return (id === 'chinese' || id === 'dangi') && hasOutdatedChineseIcuData
        ? it.skip
        : it
    }
    ...
    it('verify that Intl.DateTimeFormat.formatToParts output matches snapshot data', () => {
      ...
      const getLocalizedDates = (isoString) => {
        ...
        return calendars
          .map((id) => {
            return `${id}: ${date.toLocaleDateString(`en-US-u-ca-${id}`, {
              timeZone: 'UTC',
            })}`
          })
          .join('\n')
    ...
    const fromWithCases = {
      iso8601: {
        year2000: { year: 2000, month: 1, day: 1 },
        year1: { year: 1, month: 1, day: 1 },
      },
      buddhist: {
      ...
      hebrew: {
        year2000: { year: 5760, month: 4, day: 23 },
        year1: { year: 3761, month: 4, day: 18 },
      },
      indian: {
    ...
    for (const [id, tests] of Object.entries(fromWithCases)) {
      const dates = {
      ...
      for (const [name, date] of Object.entries(dates)) {
        ...
        const fromErrorExpected =
          ...
          (nodeVersion === '12' && fromValues.node12 === RangeError)
        itOrSkip(id)(
          `from: ${id} ${name} ${fromErrorExpected ? ' (throws)' : ''}`,
          () => {
            ...
            const inCal = date.withCalendar(id)
            equal(
              `${name} ${id} day: ${inCal.day}`,
              `${name} ${id} day: ${values.day}`
            )
            ...
            equal(
              `${name} ${id} eraYear: ${inCal.eraYear}`,
              `${name} ${id} eraYear: ${values.eraYear}`
            )
            equal(
              `${name} ${id} era: ${inCal.era}`,
              `${name} ${id} era: ${values.era}`
            )
            equal(
              `${name} ${id} year: ${inCal.year}`,
              `${name} ${id} year: ${values.year}`
            )

            equal(
              `${name} ${id} month: ${inCal.month}`,
              `${name} ${id} month: ${values.month}`
            )
            ...
            equal(
              `${name} ${id} monthCode: ${inCal.monthCode}`,
              `${name} ${id} monthCode: ${values.monthCode}`
            )
            ...
            if (logPerf) {
              console.log(
                `from: ${id} ${name}: ${ms.toFixed(
                  2
                )}ms, total: ${totalNow.toFixed(2)}ms`
              )
            }
          }
        )
        ...
        const withErrorExpected =
          ...
          (nodeVersion === '12' && withValues.node12 === RangeError)
        itOrSkip(id)(
          `with: ${id} ${name} ${withErrorExpected ? ' (throws)' : ''}`,
          () => {
            const now = globalThis.performance
              ? globalThis.performance.now()
              : Date.now()
    ...
    */
    ...
    const addYearsMonthsDaysCases = Object.entries(addMonthsCases).reduce(
      (obj, entry) => {
        obj[entry[0]] =
          entry[1] === RangeError ? RangeError : { ...entry[1], day: 4 }
        return obj
      },
      {}
    )
    const tests = {
      ...
      months: {
        ...
        startDate: { year: 2000, month: 12, day: 1 },
      },
      years: {
    ...
    for (const id of calendars) {
      for (let [unit, { duration, results, startDate }] of Object.entries(
        tests
      )) {
        ...
        itOrSkip(id)(`${id} add ${duration}`, () => {
          ...
          if (values === RangeError) {
            throws(() => {
              return Temporal.PlainDate.from({ ...startDate, calendar: id })
            })
            return
          }
          ...
          equal(
            `add ${unit} ${id} day: ${end.day}`,
            `add ${unit} ${id} day: ${values.day}`
          )
          equal(
            `add ${unit} ${id} eraYear: ${end.eraYear}`,
            `add ${unit} ${id} eraYear: ${values.eraYear}`
          )
          equal(
            `add ${unit} ${id} era: ${end.era}`,
            `add ${unit} ${id} era: ${values.era}`
          )
          equal(
            `add ${unit} ${id} year: ${end.year}`,
            `add ${unit} ${id} year: ${values.year}`
          )
          equal(
            `add ${unit} ${id} month: ${end.month}`,
            `add ${unit} ${id} month: ${values.month}`
          )
          equal(
            `add ${unit} ${id} monthCode: ${end.monthCode}`,
            `add ${unit} ${id} monthCode: ${values.monthCode}`
          )
          const calculatedStart = end.subtract(duration)
          equal(
            `start ${calculatedStart.toString()}`,
            `start ${start.toString()}`
          )
          const diff = start.until(end, { largestUnit: unit })
          equal(
            `diff ${unit} ${id}: ${diff}`,
            `diff ${unit} ${id}: ${duration}`
          )
          const ms =
            (globalThis.performance
              ? globalThis.performance.now()
    ...
    */
    const daysInMonthCases = {
      ...
      dangi: {
        year: 2001,
        leap: 'M04L',
        days: [30, 30, 30, 29, 29, 30, 29, 29, 30, 29, 30, 29, 30],
      },
      ethioaa: {
        year: 2001,
        leap: false,
      ...
      hebrew: {
        year: 2001,
        leap: 'M05L',
        days: [30, 30, 30, 29, 30, 30, 29, 30, 29, 30, 29, 30, 29],
      },
      indian: {
        year: 2001,
        leap: false,
        days: [30, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 30],
      },
      islamic: {
        year: 2001,
        leap: false,
        days: [29, 30, 29, 29, 30, 29, 30, 30, 29, 30, 30, 29],
      },
      'islamic-umalqura': {
        year: 2001,
        leap: true,
        days: [30, 29, 30, 29, 30, 29, 30, 29, 30, 29, 30, 30],
      },
      'islamic-tbla': {
        year: 2001,
        leap: true,
    ...
    for (const id of calendars) {
      const { year, leap, days } = daysInMonthCases[id]
      const date =
      ...
      itOrSkip(id)(`${id} months check for year ${year}`, () => {
        ...
        for (
          ...
          monthStart = monthStart
            ...
            : date.add({ months: monthsInYear - 1 })
            ...
            if (leapMonthIndex && i === leapMonthIndex - 1) {
              ...
              if (['chinese', 'dangi'].includes(id)) {
                if (i === 1 || i === 12 || i === 13) {
                  ...
                  const fakeL = monthStart.with({
                    monthCode: `M${month.toString().padStart(2, '0')}L`,
                    day: 5,
                  })
                  equal(
                    `fake leap month ${fakeL.monthCode}`,
                    `fake leap month M${month.toString().padStart(2, '0')}`
                  )
    ...
    for (const test of monthDayCases) {
      const id = test.calendar
      itOrSkip(
        `monthDay works for ${id} - ${++i}: ${test.monthCode || test.month}/${
          test.day
        }`,
        () => {
          const errorExpected =
            test === RangeError ||
            ((nodeVersion === '14' || nodeVersion === '12') &&
              test.nodeBefore15 === RangeError)

          if (errorExpected) {
            throws(() => {
              return Temporal.PlainMonthDay.from({ year, month, day, calendar })
            })
            return
          }
          ...
          const { calendar, monthCode, month, day, year, isoReferenceYear } =
            test
          ...
          assert(
            monthCodeConstrained === 'M12' || monthCodeConstrained === 'M13'
          )
        }
      )
    }
  ...
  describe('Indian calendar', () => {
    it('throws in Node 12 & 14 before 1 CE', () => {
      ...
      const vulnerableToBceBug =
        new Date('0000-01-01T00:00Z').toLocaleDateString('en-US-u-ca-indian', {
          timeZone: 'UTC',
        }) !== '10/11/-79 Saka'

      if (vulnerableToBceBug) {
        throws(() => {
          return Temporal.PlainDate.from('0000-01-01').withCalendar('indian')
            .day
        }, RangeError)
      }
    })
    it('handles leap days', () => {
      const leapYearFirstDay = Temporal.PlainDate.from(
        '2004-03-21[u-ca=indian]'
      )
    ...
    it('handles non-leap years', () => {
      const nonLeapYearFirstDay = Temporal.PlainDate.from(
        '2005-03-22[u-ca=indian]'
      )
      ...
      throws(() => {
        return nonLeapYearFirstDay.with({ day: 31 }, { overflow: 'reject' })
      })
    })
  })
  ...
  describe('Hebrew leap months', () => {
    ...
    it('Invalid leap months: e.g. M02L', () => {
      for (let i = 1; i <= 12; i++) {
        if (i === 5) {
          continue
        } // M05L is the only valid month (Adar I)
        throws(() => {
          return Temporal.PlainDate.from({
            year: 5779,
  ...
  describe('DateTimeFormat', () => {
    describe('supportedLocalesOf', () => {
      it('should return an Array', () => {
        return assert(Array.isArray(Intl.DateTimeFormat.supportedLocalesOf()))
      })
    })
    ...
    describe('format', () => {
      ...
      it('should work for ZonedDateTime', () => {
        equal(
          us2.format(Temporal.ZonedDateTime.from(t1)),
          '11/18/1976, 2:23:30 PM UTC'
        )
        equal(
          at2.format(Temporal.ZonedDateTime.from(t1)),
          '18.11.1976, 14:23:30 UTC'
        )
      })
      it('should work for DateTime', () => {
        equal(
          us.format(Temporal.PlainDateTime.from(t1)),
          '11/18/1976, 2:23:30 PM'
        )
        equal(
          at.format(Temporal.PlainDateTime.from(t1)),
          '18.11.1976, 14:23:30'
        )
      })
      ...
      it('should work for YearMonth', () => {
        ...
        equal(
          us.format(t.withCalendar(usCalendar).toPlainYearMonth()),
          '11/1976'
        )
        equal(
          at.format(t.withCalendar(atCalendar).toPlainYearMonth()),
          '11.1976'
        )
      })
    ...
    describe('formatToParts', () => {
      ...
      it('should work for YearMonth', () => {
        ...
        deepEqual(
          us.formatToParts(t.withCalendar(usCalendar).toPlainYearMonth()),
          [
            { type: 'month', value: '2' },
            { type: 'literal', value: '/' },
            { type: 'year', value: '2020' },
        ...
        deepEqual(
          at.formatToParts(t.withCalendar(atCalendar).toPlainYearMonth()),
          [
            { type: 'month', value: '2' },
            { type: 'literal', value: '.' },
            { type: 'year', value: '2020' },
      ...
      it('should work for MonthDay', () => {
        const t = Temporal.PlainDate.from(t2)
        deepEqual(
          us.formatToParts(t.withCalendar(usCalendar).toPlainMonthDay()),
          [
            { type: 'month', value: '2' },
            { type: 'literal', value: '/' },
            { type: 'day', value: '20' },
        ...
        deepEqual(
          at.formatToParts(t.withCalendar(atCalendar).toPlainMonthDay()),
          [
            { type: 'day', value: '20' },
            { type: 'literal', value: '.' },
            { type: 'month', value: '2' },
    ...
    describe('formatRange', () => {
      ...
      it('should work for ZonedDateTime', () => {
        ...
        equal(
          ...
          '11/18/1976, 2:23:30 PM UTC – 2/20/2020, 8:44:56 PM UTC'
        )
        equal(
          at2.formatRange(zdt1, zdt2),
          '18.11.1976, 14:23:30 UTC – 20.2.2020, 20:44:56 UTC'
        )
      })
      it('should work for DateTime', () => {
        equal(
          us.formatRange(
            ...
            Temporal.PlainDateTime.from(t2)
          ),
      ...
      it('should work for Time', () => {
        equal(
          us.formatRange(
            Temporal.PlainTime.from(t1),
            Temporal.PlainTime.from(t2)
          ),
      ...
      it('should work for Date', () => {
        equal(
          us.formatRange(
            Temporal.PlainDate.from(t1),
            Temporal.PlainDate.from(t2)
          ),
      ...
      it('should throw a TypeError when called with dissimilar types', () => {
        return throws(() => {
          return us.formatRange(
            Temporal.Instant.from(t1),
            Temporal.PlainDateTime.from(t2)
          )
        }, TypeError)
      })
      it('should throw a RangeError when called with different calendars', () => {
        ...
        throws(() => {
          return us.formatRange(
            Temporal.PlainDate.from(t1),
            Temporal.PlainDate.from(t2).withCalendar('japanese')
          )
        }, RangeError)
      })
      it('throws for two ZonedDateTimes with different time zones', () => {
        throws(() => {
          return us2.formatRange(
            Temporal.ZonedDateTime.from(t1),
            Temporal.ZonedDateTime.from(t2)
          )
        }, RangeError)
      })
    })
