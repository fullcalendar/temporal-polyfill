...
describe('Time', () => {
  describe('time.until() works', () => {
    ...
    it(`(${two}).until(${time}) => -PT1H37M`, () => {
      return equal(`${two.until(time)}`, '-PT1H37M')
    })
    it(`(${time}).until(${two}) === (${two}).since(${time})`, () => {
      return equal(`${time.until(two)}`, `${two.since(time)}`)
    })
    it('casts argument', () => {
    ...
    it('higher units are not allowed', () => {
      throws(() => {
        return time1.until(time2, { largestUnit: 'days' })
      }, RangeError)
      throws(() => {
        return time1.until(time2, { largestUnit: 'weeks' })
      }, RangeError)
      throws(() => {
        return time1.until(time2, { largestUnit: 'months' })
      }, RangeError)
      throws(() => {
        return time1.until(time2, { largestUnit: 'years' })
      }, RangeError)
    })
    ...
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return time.until(one, badOptions)
        }, TypeError)
      })
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(`${time.until(one, options)}`, 'PT1H')
      })
    })
  ...
  describe('time.since() works', () => {
    ...
    it(`(${two}).since(${time}) => -PT1H53M`, () => {
      return equal(`${two.since(time)}`, '-PT1H53M')
    })
    it(`(${two}).since(${time}) === (${time}).until(${two})`, () => {
      return equal(`${two.since(time)}`, `${time.until(two)}`)
    })
    it('casts argument', () => {
    ...
    it('higher units are not allowed', () => {
      throws(() => {
        return time2.since(time1, { largestUnit: 'days' })
      }, RangeError)
      throws(() => {
        return time2.since(time1, { largestUnit: 'weeks' })
      }, RangeError)
      throws(() => {
        return time2.since(time1, { largestUnit: 'months' })
      }, RangeError)
      throws(() => {
        return time2.since(time1, { largestUnit: 'years' })
      }, RangeError)
    })
    it('can return lower units', () => {
    ...
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return time.since(one, badOptions)
        }, TypeError)
      })
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(`${time.since(one, options)}`, 'PT1H')
      })
    })
    const earlier = PlainTime.from('08:22:36.123456789')
    const later = PlainTime.from('12:39:40.987654321')
  ...
  describe('Time.round works', () => {
    ...
    it('throws without required smallestUnit parameter', () => {
      ...
      throws(() => {
        return time.round({ roundingIncrement: 1, roundingMode: 'ceil' })
      }, RangeError)
    })
    it('throws on disallowed or invalid smallestUnit', () => {
      ;[
        ...
        throws(() => {
          return time.round({ smallestUnit })
        }, RangeError)
      })
    })
    it('throws on invalid roundingMode', () => {
      throws(() => {
        return time.round({ smallestUnit: 'second', roundingMode: 'cile' })
      }, RangeError)
    })
    const incrementOneNearest = [
      ['hour', '14:00:00'],
    ...
    incrementOneNearest.forEach(([smallestUnit, expected]) => {
      it(`rounds to nearest ${smallestUnit}`, () => {
        return equal(
          `${time.round({ smallestUnit, roundingMode: 'halfExpand' })}`,
          expected
        )
      })
    })
    ...
    incrementOneCeil.forEach(([smallestUnit, expected]) => {
      it(`rounds up to ${smallestUnit}`, () => {
        return equal(
          `${time.round({ smallestUnit, roundingMode: 'ceil' })}`,
          expected
        )
      })
    })
    ...
    incrementOneFloor.forEach(([smallestUnit, expected]) => {
      it(`rounds down to ${smallestUnit}`, () => {
        return equal(
          `${time.round({ smallestUnit, roundingMode: 'floor' })}`,
          expected
        )
      })
      it(`truncates to ${smallestUnit}`, () => {
        return equal(
          `${time.round({ smallestUnit, roundingMode: 'trunc' })}`,
          expected
        )
      })
    })
    ...
    it('rounds to an increment of hours', () => {
      equal(
        `${time.round({ smallestUnit: 'hour', roundingIncrement: 3 })}`,
        '15:00:00'
      )
    })
    it('rounds to an increment of minutes', () => {
      equal(
        `${time.round({ smallestUnit: 'minute', roundingIncrement: 15 })}`,
        '13:45:00'
      )
    })
    it('rounds to an increment of seconds', () => {
      equal(
        `${time.round({ smallestUnit: 'second', roundingIncrement: 30 })}`,
        '13:46:30'
      )
    })
    it('rounds to an increment of milliseconds', () => {
      equal(
        `${time.round({ smallestUnit: 'millisecond', roundingIncrement: 10 })}`,
        '13:46:23.12'
      )
    })
    it('rounds to an increment of microseconds', () => {
      equal(
        `${time.round({ smallestUnit: 'microsecond', roundingIncrement: 10 })}`,
        '13:46:23.12346'
      )
    })
    it('rounds to an increment of nanoseconds', () => {
      equal(
        `${time.round({ smallestUnit: 'nanosecond', roundingIncrement: 10 })}`,
        '13:46:23.12345679'
      )
    })
    it('valid hour increments divide into 24', () => {
      ...
      ;[1, 2, 3, 4, 6, 8, 12].forEach((roundingIncrement) => {
        assert(
          time.round({ smallestUnit, roundingIncrement }) instanceof PlainTime
        )
      })
    })
    ...
    ;['millisecond', 'microsecond', 'nanosecond'].forEach((smallestUnit) => {
      it(`valid ${smallestUnit} increments divide into 1000`, () => {
        ;[1, 2, 4, 5, 8, 10, 20, 25, 40, 50, 100, 125, 200, 250, 500].forEach(
          (roundingIncrement) => {
            assert(
              time.round({ smallestUnit, roundingIncrement }) instanceof
                PlainTime
            )
          }
        )
    ...
    it('throws on increments that do not divide evenly into the next highest', () => {
      throws(() => {
        return time.round({ smallestUnit: 'hour', roundingIncrement: 29 })
      }, RangeError)
      throws(() => {
        return time.round({ smallestUnit: 'minute', roundingIncrement: 29 })
      }, RangeError)
      throws(() => {
        return time.round({ smallestUnit: 'second', roundingIncrement: 29 })
      }, RangeError)
      throws(() => {
        return time.round({
      ...
      throws(() => {
        return time.round({ smallestUnit: 'nanosecond', roundingIncrement: 29 })
      }, RangeError)
    })
    it('throws on increments that are equal to the next highest', () => {
      throws(() => {
        return time.round({ smallestUnit: 'hour', roundingIncrement: 24 })
      }, RangeError)
      throws(() => {
        return time.round({ smallestUnit: 'minute', roundingIncrement: 60 })
      }, RangeError)
      throws(() => {
        return time.round({ smallestUnit: 'second', roundingIncrement: 60 })
      }, RangeError)
      throws(() => {
        return time.round({
          smallestUnit: 'millisecond',
    ...
    ;['hour', 'minute', 'second', 'millisecond', 'microsecond'].forEach(
      (smallestUnit) => {
    ...
    it('accepts plural units', () => {
      assert(
        time
          ...
          .equals(time.round({ smallestUnit: 'hour' }))
      )
      assert(
        time
          .round({ smallestUnit: 'minutes' })
          .equals(time.round({ smallestUnit: 'minute' }))
      )
      assert(
        time
          .round({ smallestUnit: 'seconds' })
          .equals(time.round({ smallestUnit: 'second' }))
      )
      assert(
        time
          .round({ smallestUnit: 'milliseconds' })
          .equals(time.round({ smallestUnit: 'millisecond' }))
      )
      assert(
        time
          .round({ smallestUnit: 'microseconds' })
          .equals(time.round({ smallestUnit: 'microsecond' }))
      )
      assert(
        time
          .round({ smallestUnit: 'nanoseconds' })
          .equals(time.round({ smallestUnit: 'nanosecond' }))
      )
    })
  })
  describe('Time.compare() works', () => {
    ...
    it('equal', () => {
      return equal(PlainTime.compare(t1, t1), 0)
    })
    it('smaller/larger', () => {
      return equal(PlainTime.compare(t1, t2), -1)
    })
    it('larger/smaller', () => {
      return equal(PlainTime.compare(t2, t1), 1)
    })
    ...
    it('object must contain at least one correctly-spelled property', () => {
      throws(() => {
        return PlainTime.compare({ hours: 16 }, t2)
      }, TypeError)
      throws(() => {
        return PlainTime.compare(t1, { hours: 16 })
      }, TypeError)
    })
  })
  describe('time.equals() works', () => {
    ...
    const t2 = PlainTime.from('14:23:30.123')
    it('equal', () => {
      return assert(t1.equals(t1))
    })
    it('unequal', () => {
      return assert(!t1.equals(t2))
    })
    it('casts argument', () => {
  ...
  describe('time.add() works', () => {
    ...
    it('symmetric with regard to negative durations', () => {
      equal(
        `${PlainTime.from('07:23:30.123456789').add({ hours: -16 })}`,
        '15:23:30.123456789'
      )
      equal(
        `${PlainTime.from('16:08:30.123456789').add({ minutes: -45 })}`,
        '15:23:30.123456789'
      )
      equal(
        `${PlainTime.from('15:23:30.123457089').add({ nanoseconds: -300 })}`,
        '15:23:30.123456789'
      )
    })
    it('time.add(durationObj)', () => {
      equal(
        `${time.add(Temporal.Duration.from('PT16H'))}`,
        '07:23:30.123456789'
      )
    })
    it('casts argument', () => {
      return equal(`${time.add('PT16H')}`, '07:23:30.123456789')
    })
    ...
    it('mixed positive and negative values always throw', () => {
      ;['constrain', 'reject'].forEach((overflow) => {
        return throws(() => {
          return time.add({ hours: 1, minutes: -30 }, { overflow })
        }, RangeError)
      })
    })
    it('options is ignored', () => {
      ;[
        ...
        return equal(`${time.add({ hours: 1 }, options)}`, '16:23:30.123456789')
      })
      ;['', 'CONSTRAIN', 'balance', 3, null].forEach((overflow) => {
        return equal(
          `${time.add({ hours: 1 }, { overflow })}`,
          '16:23:30.123456789'
        )
      })
    })
  ...
  describe('time.subtract() works', () => {
    ...
    it(`(${time}).subtract({ hours: 16 })`, () => {
      return equal(`${time.subtract({ hours: 16 })}`, '23:23:30.123456789')
    })
    it(`(${time}).subtract({ minutes: 45 })`, () => {
      return equal(`${time.subtract({ minutes: 45 })}`, '14:38:30.123456789')
    })
    it(`(${time}).subtract({ seconds: 45 })`, () => {
      return equal(`${time.subtract({ seconds: 45 })}`, '15:22:45.123456789')
    })
    it(`(${time}).subtract({ milliseconds: 800 })`, () => {
      return equal(
        `${time.subtract({ milliseconds: 800 })}`,
        '15:23:29.323456789'
      )
    })
    it(`(${time}).subtract({ microseconds: 800 })`, () => {
      return equal(
        `${time.subtract({ microseconds: 800 })}`,
        '15:23:30.122656789'
      )
    })
    it(`(${time}).subtract({ nanoseconds: 800 })`, () => {
      return equal(
        `${time.subtract({ nanoseconds: 800 })}`,
        '15:23:30.123455989'
      )
    })
    it('symmetric with regard to negative durations', () => {
      equal(
        `${PlainTime.from('23:23:30.123456789').subtract({ hours: -16 })}`,
        '15:23:30.123456789'
      )
      equal(
        `${PlainTime.from('14:38:30.123456789').subtract({ minutes: -45 })}`,
        '15:23:30.123456789'
      )
      equal(
        `${PlainTime.from('15:22:45.123456789').subtract({ seconds: -45 })}`,
        '15:23:30.123456789'
      )
      equal(
        `${PlainTime.from('15:23:29.323456789').subtract({
          milliseconds: -800,
        })}`,
        '15:23:30.123456789'
      )
      equal(
        `${PlainTime.from('15:23:30.122656789').subtract({
          microseconds: -800,
        })}`,
        '15:23:30.123456789'
      )
      equal(
        `${PlainTime.from('15:23:30.123455989').subtract({
          nanoseconds: -800,
        })}`,
        '15:23:30.123456789'
      )
    ...
    it('time.subtract(durationObj)', () => {
      equal(
        `${time.subtract(Temporal.Duration.from('PT16H'))}`,
        '23:23:30.123456789'
      )
    })
    it('casts argument', () => {
      return equal(`${time.subtract('PT16H')}`, '23:23:30.123456789')
    })
    it('ignores higher units', () => {
    ...
    it('mixed positive and negative values always throw', () => {
      ;['constrain', 'reject'].forEach((overflow) => {
        return throws(() => {
          return time.subtract({ hours: 1, minutes: -30 }, { overflow })
        }, RangeError)
      })
    })
    it('options is ignored', () => {
      ;[
        ...
        return equal(
          `${time.subtract({ hours: 1 }, options)}`,
          '14:23:30.123456789'
        )
      })
      ;['', 'CONSTRAIN', 'balance', 3, null].forEach((overflow) => {
        return equal(
          `${time.subtract({ hours: 1 }, { overflow })}`,
          '14:23:30.123456789'
        )
      })
    })
    it('object must contain at least one correctly-spelled property', () => {
      ...
      throws(() => {
        return time.subtract({ minute: 12 })
      }, TypeError)
    })
    it('incorrectly-spelled properties are ignored', () => {
  ...
  describe('time.toString() works', () => {
    ...
    it('new Time(15, 23, 30, 123, 456, 789).toString()', () => {
      equal(
        new PlainTime(15, 23, 30, 123, 456, 789).toString(),
        '15:23:30.123456789'
      )
    })
    ...
    it('truncates to minute', () => {
      ;[t1, t2, t3].forEach((t) => {
        return equal(t.toString({ smallestUnit: 'minute' }), '15:23')
      })
    })
    ...
    it('throws on invalid or disallowed smallestUnit', () => {
      ;['era', 'year', 'month', 'day', 'hour', 'nonsense'].forEach(
        (smallestUnit) => {
          return throws(() => {
            return t1.toString({ smallestUnit })
          }, RangeError)
        }
      )
    })
    ...
    it('throws on out of range or invalid fractionalSecondDigits', () => {
      ;[-1, 10, Infinity, NaN, 'not-auto'].forEach((fractionalSecondDigits) => {
        return throws(() => {
          return t1.toString({ fractionalSecondDigits })
        }, RangeError)
      })
    })
    ...
    it('throws on invalid roundingMode', () => {
      throws(() => {
        return t1.toString({ roundingMode: 'cile' })
      }, RangeError)
    })
    ...
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return t1.toString(badOptions)
        }, TypeError)
      })
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(t1.toString(options), '15:23:00')
      })
    })
  })
  describe('Time.from() works', () => {
    ...
    it('Time.from({ hour: 15, minute: 23 })', () => {
      return equal(`${PlainTime.from({ hour: 15, minute: 23 })}`, '15:23:00')
    })
    it('Time.from({ minute: 30, microsecond: 555 })', () => {
      return equal(
        `${PlainTime.from({ minute: 30, microsecond: 555 })}`,
        '00:30:00.000555'
      )
    })
    ...
    it('Time.from(number) is converted to string', () => {
      return equal(`${PlainTime.from(1523)}`, `${PlainTime.from('1523')}`)
    })
    ...
    it('any number of decimal places', () => {
      ...
      equal(
        `${PlainTime.from('1976-11-18T15:23:30.123456Z')}`,
        '15:23:30.123456'
      )
      equal(
        `${PlainTime.from('1976-11-18T15:23:30.1234567Z')}`,
        '15:23:30.1234567'
      )
      equal(
        `${PlainTime.from('1976-11-18T15:23:30.12345678Z')}`,
        '15:23:30.12345678'
      )
      equal(
        `${PlainTime.from('1976-11-18T15:23:30.123456789Z')}`,
        '15:23:30.123456789'
      )
    })
    ...
    it('variant minus sign', () => {
      equal(
        `${PlainTime.from('1976-11-18T15:23:30.12\u221202:00')}`,
        '15:23:30.12'
      )
    })
    it('basic format', () => {
    ...
    it('no junk at end of string', () => {
      return throws(() => {
        return PlainTime.from('15:23:30.100junk')
      }, RangeError)
    })
    it('options may only be an object or undefined', () => {
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return PlainTime.from({ hour: 12 }, badOptions)
        }, TypeError)
      })
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(`${PlainTime.from({ hour: 12 }, options)}`, '12:00:00')
      })
    })
    describe('Overflow', () => {
      ...
      it('reject', () => {
        return throws(() => {
          return PlainTime.from(bad, { overflow: 'reject' })
        }, RangeError)
      })
      it('constrain', () => {
        equal(`${PlainTime.from(bad)}`, '00:00:00.000000999')
        equal(
          `${PlainTime.from(bad, { overflow: 'constrain' })}`,
          '00:00:00.000000999'
        )
      })
      it('throw on bad overflow', () => {
        ;[new PlainTime(15), { hour: 15 }, '15:00'].forEach((input) => {
          ;['', 'CONSTRAIN', 'balance', 3, null].forEach((overflow) => {
            return throws(() => {
              return PlainTime.from(input, { overflow })
            }, RangeError)
          })
        })
      })
      ...
      it('reject leap second', () => {
        return throws(() => {
          return PlainTime.from(leap, { overflow: 'reject' })
        }, RangeError)
      })
      it('constrain leap second', () => {
        return equal(`${PlainTime.from(leap)}`, '23:59:59')
      })
      it('constrain has no effect on invalid ISO string', () => {
        throws(() => {
          return PlainTime.from('24:60', { overflow: 'constrain' })
        }, RangeError)
      })
    })
    it('object must contain at least one correctly-spelled property', () => {
      ...
      throws(() => {
        return PlainTime.from({ minutes: 12 })
      }, TypeError)
    })
    it('incorrectly-spelled properties are ignored', () => {
  ...
  describe('time operations', () => {
    ...
    it(`Temporal.PlainTime.from(${JSON.stringify(
      datetime
    )}) instanceof Temporal.PlainTime`, () => {
      return assert(PlainTime.from(datetime) instanceof PlainTime)
    })
    it(`Temporal.PlainTime.from(${JSON.stringify(
      datetime
    )}) === ${fromed}`, () => {
      return assert(PlainTime.from(datetime).equals(fromed))
    })

    const iso = '20:18:32'
    it(`Temporal.PlainTime.from("${iso}") === (${iso})`, () => {
      return equal(`${PlainTime.from(iso)}`, iso)
    })
  })
