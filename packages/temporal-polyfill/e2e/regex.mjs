...
describe('fromString regex', () => {
  describe('instant', () => {
    function test(isoString, components) {
      it(isoString, () => {
        const [y, mon, d, h = 0, min = 0, s = 0, ms = 0, µs = 0, ns = 0] =
          components
    ...
    ;[
      ...
      generateTest(
        '1976-11-18T15:23',
        `${zoneString}[Europe/Vienna]`,
        [1976, 11, 18, 14, 23, 30, 123, 456, 789]
      )
      generateTest(
        '1976-11-18T15:23',
        `+01:00[${zoneString}]`,
    ...
    ;[
      ...
      return generateTest(
        '1976-11-18T15:23',
        zoneString,
        [1976, 11, 18, 19, 23, 30, 123, 456, 789]
      )
    })
    ...
    test(
      ...
      [1976, 11, 18, 15, 23, 30, 123, 456, 700]
    )
    test(
      '1976-11-18T15:23:30.12345678Z',
      [1976, 11, 18, 15, 23, 30, 123, 456, 780]
    )
    ...
    ;['\u221204:00', '\u221204', '\u22120400'].forEach((offset) => {
      return test(
        `1976-11-18T15:23:30.1234${offset}`,
        [1976, 11, 18, 19, 23, 30, 123, 400]
      )
    })
    test(
      '\u2212009999-11-18T15:23:30.1234Z',
      [-9999, 11, 18, 15, 23, 30, 123, 400]
    )
  ...
  describe('datetime', () => {
    ...
    // Time separators
    ;['T', 't', ' '].forEach((timeSep) => {
      return generateTest(`1976-11-18${timeSep}15:23`, '')
    })
    ...
    ;[
      ...
      return generateTest('1976-11-18T15:23', zoneString)
    })
    // Various numbers of decimal places
    ...
    ;['\u221204:00', '\u221204', '\u22120400'].forEach((offset) => {
      return test(
        `1976-11-18T15:23:30.1234${offset}`,
        [1976, 11, 18, 15, 23, 30, 123, 400]
      )
    })
    test(
      '\u2212009999-11-18T15:23:30.1234',
      [-9999, 11, 18, 15, 23, 30, 123, 400]
    )
    // Mixture of basic and extended format
    ...
    ;[
      ...
      return test(
        `1976-11-18T15:23:30.123456789${zoneString}[u-ca=iso8601]`,
        [1976, 11, 18, 15, 23, 30, 123, 456, 789]
      )
    })
  })
  ...
  describe('date', () => {
    ...
    ;[
      ...
      return test(`1976-11-18T15:23:30.${decimals}`, [1976, 11, 18])
    })
    ;[
      // Comma decimal separator
  ...
  describe('yearmonth', () => {
    ...
    ;[
      ...
      return test(`1976-11-18T15:23:30.${decimals}`, [1976, 11])
    })
    ;[
      // Comma decimal separator
      '1976-11-18T15:23:30,1234',
  ...
  describe('monthday', () => {
    ...
    ;[
      ...
      return test(`1976-11-18T15:23:30.${decimals}`, [11, 18])
    })
    ;[
      // Comma decimal separator
      '1976-11-18T15:23:30,1234',
  ...
  describe('timezone', () => {
    ...
    // Time separators
    ;['T', 't', ' '].forEach((timeSep) => {
      return generateTest(`1976-11-18${timeSep}15:23`, 'Z', 'UTC')
    })
    // Time zone with bracketed name
    ;[
      '+01:00',
    ...
    ;[
      ...
      return generateTest('1976-11-18T15:23', zoneString, '-04:00')
    })
    // Various numbers of decimal places
    ;[
      '1',
      ...
      return test(`1976-11-18T15:23:30.${decimals}Z`, 'UTC')
    })
    // Lowercase UTC designator
    ...
    // Unicode minus sign
    ;['\u221204:00', '\u221204', '\u22120400'].forEach((offset) => {
      return test(`1976-11-18T15:23${offset}`, '-04:00')
    })
    ;[
      // Mixture of basic and extended format
      '1976-11-18T152330',
      ...
      ;['+01:00', '+01', '+0100', ''].forEach((zoneString) => {
        return test(
          `${dateTimeString}${zoneString}[Europe/Vienna]`,
          'Europe/Vienna'
        )
      })
      ;['-04:00', '-04', '-0400'].forEach((zoneString) => {
        return test(`${dateTimeString}${zoneString}`, '-04:00')
      })
    ...
    test(
      '1976-11-18T15:23:30.123456789[Europe/Vienna][u-ca=iso8601]',
      'Europe/Vienna'
    )
    test(
      '1976-11-18T15:23:30.123456789+01:00[Europe/Vienna][u-ca=iso8601]',
      'Europe/Vienna'
    )
  })
  ...
  describe('duration', () => {
    ...
    for (const [d, dexpect] of day) {
      for (const [t, texpect] of tim) {
  ...
  describe.skip('time zone ID', () => {
    const oldTemporalTimeZoneFrom = Temporal.TimeZone.from
    let fromCalledWith
    before(() => {
  ...
  describe.skip('calendar ID', () => {
    const oldTemporalCalendarFrom = Temporal.Calendar.from
    let fromCalledWith
    before(() => {
    ...
    function testCalendarID(id) {
      return Temporal.PlainDateTime.from(
        `1970-01-01T00:00+00:00[UTC][u-ca=${id}]`
      )
    }
    describe('valid', () => {
