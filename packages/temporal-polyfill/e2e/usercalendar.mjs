...
describe('Userland calendar', () => {
  describe('Trivial subclass', () => {
    ...
    it('is a calendar', () => {
      return equal(typeof obj, 'object')
    })
    it('.id property', () => {
      return equal(obj.id, 'two-based')
    })
    // FIXME: what should happen in Temporal.Calendar.from(obj)?
    it('.id is not available in from()', () => {
      throws(() => {
        return Temporal.Calendar.from('two-based')
      }, RangeError)
      throws(() => {
        return Temporal.Calendar.from(
          '2020-06-05T09:34-07:00[America/Vancouver][u-ca=two-based]'
        )
      }, RangeError)
    })
    it('Temporal.PlainDate.from()', () => {
      return equal(`${date}`, '2020-04-05[u-ca=two-based]')
    })
    ...
    it('Temporal.PlainDateTime.from()', () => {
      return equal(`${dt}`, '2020-04-05T12:00:00[u-ca=two-based]')
    })
    ...
    it('Temporal.PlainYearMonth.from()', () => {
      return equal(`${ym}`, '2020-04-01[u-ca=two-based]')
    })
    ...
    it('Temporal.PlainMonthDay.from()', () => {
      return equal(`${md}`, '1972-04-05[u-ca=two-based]')
    })
  ...
  describe('Trivial protocol implementation', () => {
    ...
    function isoToDecimal(date) {
      ...
      const year = Math.floor(days / 100)
      days %= 100
      return { year, days }
    }
    const obj = {
    ...
    it('.id is not available in from()', () => {
      throws(() => {
        return Temporal.Calendar.from('decimal')
      }, RangeError)
      throws(() => {
        return Temporal.Calendar.from(
          '2020-06-05T09:34-07:00[America/Vancouver][u-ca=decimal]'
        )
      }, RangeError)
    })
    it('Temporal.PlainDate.from()', () => {
      return equal(`${date}`, '2020-06-05[u-ca=decimal]')
    })
    it('Temporal.PlainDate fields', () => {
      equal(date.year, 184)
      equal(date.month, 2)
    ...
    it('Temporal.PlainDateTime.from()', () => {
      return equal(`${dt}`, '2020-06-05T12:00:00[u-ca=decimal]')
    })
    it('Temporal.PlainDateTime fields', () => {
      equal(dt.year, 184)
      equal(dt.month, 2)
    ...
    it('Temporal.PlainYearMonth.from()', () => {
      return equal(`${ym}`, '2020-05-28[u-ca=decimal]')
    })
    it('Temporal.PlainYearMonth fields', () => {
      equal(dt.year, 184)
      equal(dt.month, 2)
    ...
    it('Temporal.PlainMonthDay.from()', () => {
      return equal(`${md}`, '1970-01-19[u-ca=decimal]')
    })
    it('Temporal.PlainMonthDay fields', () => {
  ...
  describe('calendar with extra fields', () => {
    ...
    it('accepts season in with()', () => {
      equal(
        `${datetime.with({ season: 2 })}`,
        '2019-06-15T00:00:00[u-ca=season]'
      )
      ...
      equal(
        `${zoned.with({ season: 2 })}`,
        '2019-06-15T00:00:00+00:00[UTC][u-ca=season]'
      )
    })
    it('translates month correctly in with()', () => {
      equal(
        `${datetime.with({ month: 2 })}`,
        '2019-08-15T00:00:00[u-ca=season]'
      )
      ...
      equal(
        `${zoned.with({ month: 2 })}`,
        '2019-08-15T00:00:00+00:00[UTC][u-ca=season]'
      )
    })
    after(() => {
    ...
    class CenturyCalendar extends Temporal.Calendar {
      ...
      _validateFields(fields) {
        ...
        if ((century === undefined) !== (centuryYear === undefined)) {
          throw new TypeError(
            'pass either both or neither of century and centuryYear'
          )
        }
        ...
        if (century !== undefined) {
          const centuryCalculatedYear = (century - 1) * 100 + centuryYear

          if (year !== centuryCalculatedYear) {
            throw new RangeError(
              'year must agree with century/centuryYear if both given'
            )
          }
        }
        return year
