...
describe('TimeZone', () => {
  describe('Structure', () => {
    it('Temporal.TimeZone is a function', () => {
      return equal(typeof Temporal.TimeZone, 'function')
    })
    it('Temporal.TimeZone has prototype', () => {
      return equal(typeof Temporal.TimeZone.prototype, 'object')
    })
    describe('Temporal.TimeZone.prototype', () => {
      it('Temporal.TimeZone.prototype has id', () => {
        return assert('id' in Temporal.TimeZone.prototype)
      })
      ...
      it('Temporal.TimeZone.prototype has toString', () => {
        return equal(typeof Temporal.TimeZone.prototype.toString, 'function')
      })
    })
    it('Temporal.TimeZone has from', () => {
      return equal(typeof Temporal.TimeZone.from, 'function')
    })
  })
  describe('Construction', () => {
    ...
    function test(zone) {
      it(`${zone} is a zone`, () => {
        return equal(typeof new Temporal.TimeZone(zone), 'object')
      })
    }
    ;['+00:01.1', '-01.1'].forEach((id) => {
      it(`${id} is not a zone`, () => {
        return throws(() => {
          return new Temporal.TimeZone(id)
        }, RangeError)
      })
    })
  })
  describe('.id property', () => {
    ...
    function test(zone, id = zone) {
      it(`${zone} has ID ${id}`, () => {
        return equal(new Temporal.TimeZone(zone).id, id)
      })
    }
  })
  describe('TimeZone.from(identifier)', () => {
    ...
    function test(zone) {
      ...
      it(`TimeZone.from(${zone}) is a time zone`, () => {
        return equal(typeof timezoneFrom, 'object')
      })
      it(`TimeZone.from(${zone}) does the same thing as new TimeZone(${zone})`, () => {
        return equal(timezoneFrom.id, timezoneObj.id)
      })
    }
    ...
    it('throws with bad identifier', () => {
      ;['local', 'Z', '-08:00[America/Vancouver]', '+00:01.1', '-01.1'].forEach(
        (bad) => {
          throws(() => {
            return Temporal.TimeZone.from(bad)
          }, RangeError)
        }
      )
    })
    it('throws with bad value in property bag', () => {
      throws(() => {
        return Temporal.TimeZone.from({ timeZone: 'local' })
      }, RangeError)
      throws(() => {
        return Temporal.TimeZone.from({
  ...
  describe('TimeZone.from(ISO string)', () => {
    ...
    function test(isoString, id) {
      ...
      it(`TimeZone.from(${isoString}) is a time zone`, () => {
        return equal(typeof tz, 'object')
      })
      it(`TimeZone.from(${isoString}) has ID ${id}`, () => {
        return equal(tz.id, id)
      })
    }
    it('offset disagreeing with IANA name throws', () => {
      throws(() => {
        return Temporal.TimeZone.from('1994-11-05T08:15:30-05:00[UTC]')
      }, RangeError)
      throws(() => {
        return Temporal.TimeZone.from(
      ...
      throws(() => {
        return Temporal.TimeZone.from('1994-11-05T13:15:30-03[Europe/Brussels]')
      }, RangeError)
    })
    it('offset out of range throws', () => {
      throws(() => {
        return Temporal.TimeZone.from('1994-11-05T08:15:30+25:00')
      }, RangeError)
      throws(() => {
        return Temporal.TimeZone.from('1994-11-05T13:15:30-25:00')
      }, RangeError)
    })
  })
  describe('+01:00', () => {
    const zone = new Temporal.TimeZone('+01:00')
    const inst = Temporal.Instant.fromEpochSeconds(
      Math.floor(Math.random() * 1e9)
    )
    const dtm = new Temporal.PlainDateTime(
      1976,
      11,
      18,
      15,
    ...
    it(`${zone} has ID ${zone}`, () => {
      return equal(zone.id, `${zone}`)
    })
    it(`${zone} has offset +01:00 in ns`, () => {
      return equal(zone.getOffsetNanosecondsFor(inst), 3600e9)
    })
    it(`${zone} has offset +01:00`, () => {
      return equal(zone.getOffsetStringFor(inst), '+01:00')
    })
    it(`(${zone}).getPlainDateTimeFor(${inst})`, () => {
      return assert(
        zone.getPlainDateTimeFor(inst) instanceof Temporal.PlainDateTime
      )
    })
    it(`(${zone}).getInstantFor(${dtm})`, () => {
      return assert(zone.getInstantFor(dtm) instanceof Temporal.Instant)
    })
    it(
      `(${zone}).getNextTransition(${inst})`,
      () => {
        return zone.getNextTransition(inst)
      },
      null
    )
    it(
      `(${zone}).getPreviousTransition(${inst})`,
      () => {
        return zone.getPreviousTransition(inst)
      },
      null
    )
    it('wraps around to the next day', () => {
      return equal(
        `${zone.getPlainDateTimeFor(
          Temporal.Instant.from('2020-02-06T23:59Z')
        )}`,
        '2020-02-07T00:59:00'
      )
    })
  ...
  describe('UTC', () => {
    ...
    it(`${zone} has offset +00:00 in ns`, () => {
      return equal(zone.getOffsetNanosecondsFor(inst), 0)
    })
    it(`${zone} has offset +00:00`, () => {
      return equal(zone.getOffsetStringFor(inst), '+00:00')
    })
    it(`(${zone}).getPlainDateTimeFor(${inst})`, () => {
      return assert(
        zone.getPlainDateTimeFor(inst) instanceof Temporal.PlainDateTime
  ...
  describe('America/Los_Angeles', () => {
    ...
    it(`${zone} has offset -08:00 in ns`, () => {
      return equal(zone.getOffsetNanosecondsFor(inst), -8 * 3600e9)
    })
    it(`${zone} has offset -08:00`, () => {
      return equal(zone.getOffsetStringFor(inst), '-08:00')
    })
    it(`(${zone}).getPlainDateTimeFor(${inst})`, () => {
      return assert(
        zone.getPlainDateTimeFor(inst) instanceof Temporal.PlainDateTime
  ...
  describe('sub-minute offset', () => {
    ...
    it(`${zone} has offset +00:19:32 in ns`, () => {
      return equal(zone.getOffsetNanosecondsFor(inst), 1172000000000)
    })
    it(`${zone} has offset +00:19:32`, () => {
      return equal(zone.getOffsetStringFor(inst), '+00:19:32')
    })
    it(`(${zone}).getPlainDateTimeFor(${inst})`, () => {
      return equal(`${zone.getPlainDateTimeFor(inst)}`, '1900-01-01T12:19:32')
    })
    it(`(${zone}).getInstantFor(${dtm})`, () => {
      return equal(`${zone.getInstantFor(dtm)}`, '1900-01-01T11:40:28Z')
    })
    it(
      `(${zone}).getNextTransition(${inst})`,
      () => {
  ...
  describe('with DST change', () => {
    it('clock moving forward', () => {
      ...
      equal(
        `${zone.getInstantFor(dtm, { disambiguation: 'earlier' })}`,
        '2019-03-31T00:45:00Z'
      )
      equal(
        `${zone.getInstantFor(dtm, { disambiguation: 'later' })}`,
        '2019-03-31T01:45:00Z'
      )
      equal(
        `${zone.getInstantFor(dtm, { disambiguation: 'compatible' })}`,
        '2019-03-31T01:45:00Z'
      )
      throws(() => {
        return zone.getInstantFor(dtm, { disambiguation: 'reject' })
      }, RangeError)
    })
  ...
  describe('Casting', () => {
    ...
    it('getOffsetNanosecondsFor() casts only from string', () => {
      throws(() => {
        return zone.getOffsetNanosecondsFor(0n)
      }, RangeError)
      throws(() => {
        return zone.getOffsetNanosecondsFor({})
      }, RangeError)
    })
    ...
    it('getOffsetStringFor() casts only from string', () => {
      throws(() => {
        return zone.getOffsetStringFor(0n)
      }, RangeError)
      throws(() => {
        return zone.getOffsetStringFor({})
      }, RangeError)
    })
    it('getPlainDateTimeFor() casts its argument', () => {
      equal(
        `${zone.getPlainDateTimeFor('2019-02-17T01:45Z')}`,
        '2019-02-17T05:15:00'
      )
    })
    it('getPlainDateTimeFor() casts only from string', () => {
      throws(() => {
        return zone.getPlainDateTimeFor(0n)
      }, RangeError)
      throws(() => {
        return zone.getPlainDateTimeFor({})
      }, RangeError)
    })
  })
  describe('TimeZone.getInstantFor() works', () => {
    ...
    it('outside of Instant range', () => {
      ...
      throws(() => {
        return offsetTz.getInstantFor(max)
      }, RangeError)

      const namedTz = Temporal.TimeZone.from('America/Godthab')
      throws(() => {
        return namedTz.getInstantFor(max)
      }, RangeError)
    })
    it('options may only be an object or undefined', () => {
      ...
      ;[null, 1, 'hello', true, Symbol('foo'), 1n].forEach((badOptions) => {
        return throws(() => {
          return tz.getInstantFor(dt, badOptions)
        }, TypeError)
      })
      ;[{}, () => {}, undefined].forEach((options) => {
        return equal(
          `${tz.getInstantFor(dt, options)}`,
          '2019-10-29T13:46:38.271986102Z'
        )
      })
    })
    it('casts argument', () => {
      const tz = Temporal.TimeZone.from('Europe/Amsterdam')
      equal(
        `${tz.getInstantFor('2019-10-29T10:46:38.271986102')}`,
    ...
    it('object must contain at least the required properties', () => {
      const tz = Temporal.TimeZone.from('Europe/Amsterdam')
      throws(() => {
        return tz.getInstantFor({ year: 2019 })
      }, TypeError)
    })
  })
  describe('getInstantFor disambiguation', () => {
    ...
    it('with constant offset', () => {
      ...
      for (const disambiguation of [
        ...
        assert(
          zone.getInstantFor(dtm, { disambiguation }) instanceof
            Temporal.Instant
        )
      }
    })
    ...
    it('with daylight saving change - Spring', () => {
      ...
      equal(
        `${zone.getInstantFor(dtmLA, { disambiguation: 'earlier' })}`,
        '2020-03-08T09:30:00Z'
      )
      equal(
        `${zone.getInstantFor(dtmLA, { disambiguation: 'later' })}`,
        '2020-03-08T10:30:00Z'
      )
      equal(
        `${zone.getInstantFor(dtmLA, { disambiguation: 'compatible' })}`,
        '2020-03-08T10:30:00Z'
      )
      throws(() => {
        return zone.getInstantFor(dtmLA, { disambiguation: 'reject' })
      }, RangeError)
    })
    it('throws on bad disambiguation', () => {
      ...
      ;['', 'EARLIER', 'test', 3, null].forEach((disambiguation) => {
        return throws(() => {
          return zone.getInstantFor(dtm, { disambiguation })
        }, RangeError)
      })
    })
  })
  describe('getPossibleInstantsFor', () => {
    it('with constant offset', () => {
      ...
      deepEqual(
        zone.getPossibleInstantsFor(dt).map((a) => {
          return `${a}`
        }),
    ...
    it('outside of Instant range', () => {
      ...
      const offsetTz = Temporal.TimeZone.from('-01:00')
      throws(() => {
        return offsetTz.getPossibleInstantsFor(max)
      }, RangeError)

      const namedTz = Temporal.TimeZone.from('America/Godthab')
      throws(() => {
        return namedTz.getPossibleInstantsFor(max)
      }, RangeError)
    })
    it('casts argument', () => {
      ...
      deepEqual(
        tz.getPossibleInstantsFor('2019-02-16T23:45:30').map((a) => {
          return `${a}`
        }),
        ['2019-02-16T20:15:30Z']
      )
    ...
    it('object must contain at least the required properties', () => {
      const tz = Temporal.TimeZone.from('Europe/Amsterdam')
      throws(() => {
        return tz.getPossibleInstantsFor({ year: 2019 })
      }, TypeError)
    })
  })
  describe('getNextTransition works', () => {
    ...
    it('casts argument', () => {
      equal(
        `${nyc.getNextTransition('2019-04-16T21:01Z')}`,
        '2019-11-03T06:00:00Z'
      )
    })
    it('casts only from string', () => {
      throws(() => {
        return nyc.getNextTransition(0n)
      }, RangeError)
      throws(() => {
        return nyc.getNextTransition({})
      }, RangeError)
    })
  })
  ...
  describe('getPreviousTransition works', () => {
    ...
    it('casts argument', () => {
      equal(
        `${london.getPreviousTransition('2020-06-11T21:01Z')}`,
        '2020-03-29T01:00:00Z'
      )
    })
    it('casts only from string', () => {
      throws(() => {
        return london.getPreviousTransition(0n)
      }, RangeError)
      throws(() => {
        return london.getPreviousTransition({})
      }, RangeError)
    })
  })
})
