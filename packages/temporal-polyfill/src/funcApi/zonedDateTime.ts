...
export const withCalendar = NativeTemporal
  ? Native.withCalendar
  : Shim.withCalendar
export const withTimeZone = NativeTemporal
  ? Native.withTimeZone
  : Shim.withTimeZone
export const withPlainTime = NativeTemporal
  ? Native.withPlainTime
  : Shim.withPlainTime
export const offsetNanoseconds = NativeTemporal
  ? Native.offsetNanoseconds
  : Shim.offsetNanoseconds
export const offset = NativeTemporal ? Native.offset : Shim.offset
...
export const getTimeZoneTransition = NativeTemporal
...
export const toInstant = NativeTemporal ? Native.toInstant : Shim.toInstant
