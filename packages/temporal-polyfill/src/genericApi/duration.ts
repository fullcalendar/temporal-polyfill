...
import { MarkerSlots, absDuration, addToDuration, checkDurationFields, compareDurations, negateDuration, queryDurationSign, roundDuration } from '../internal/durationMath'
